...
(function (e) {
    ...
    e.pixelentity.browser = {iDev: b, android: a, mobile: c}
}(jQuery));
(function (a) {
    a.pixelentity = a.pixelentity || {version: "1.0.0"};
    a.pixelentity.Geom = {getScaler: function (o, j, k, n, g, i, c) {
        var e = {};
        var d = n / i;
        var m = g / c;
        var b;
...
(function (c) {
    ...
    var a = c.pixelentity.preloader = {load: function (g, k, j) {
...
(function (g) {
    var e = (new Image()).style, d = "ransition", h, f;
...
var Froogaloop = (function () {
    ...
    var l = {}, e = false, k = Array.prototype.slice;
    c.fn = c.prototype = {playerDomain: "", element: null, init: function (m) {
        if (typeof m === "string") {
        ...
        var m = this, o = m.element, n = o.id != "" ? o.id : null, q = !d(p) ? p : null, r = d(p) ? p : null;
        if (r) {
            i(s, r, n)
        }
        j(s, q, o);
        ...
        var m = this, p = m.element, o = p.id != "" ? p.id : null, q = f(n, o);
        if (n != "ready" && q) {
    ...
    function j(q, p, o) {
        ...
        var m = o.getAttribute("src").split("?")[0], n = JSON.stringify({method: q, value: p});
    ...
    function b(o) {
        ...
        var q = JSON.parse(o.data), p = q.value, t = q.event || q.method, n = q.data, m = m == "" ? null : q.player_id, s = g(t, m), r = [];
        if (!s) {
            return false
        }
        if (p !== undefined) {
...
jQuery(function ($) {
    ...
    projekktor = $p = function () {
        ...
        function PPlayer(srcNode, cfg, onReady) {
            ...
            this._queue = [];
            this.env = {muted: false, inFullscreen: false, playerStyle: null, scrollTop: null, scrollLeft: null, bodyOverflow: null, playerDom: null, mediaContainer: null, agent: "standard", mouseIsOver: false, loading: false, autoSize: false, className: "", onReady: onReady};
            this.media = [null];
            this._plugins = [];
            this.listeners = [];
            this.playerModel = {};
            ...
            this._reelUpdate = function (obj) {
                ...
                switch (typeof obj) {
                    default:
                        obj = [
                            {file: "", type: "", errorCode: 98}
                        ];
                        break;
                    case"object":
                        if (obj.length == 0) {
                            obj = [
                                {file: "", type: "", errorCode: 97}
                            ]
                        }
                        break;
                    case"undefined":
            ...
            this._prepareMedia = function (data) {
                var mediaFile = "", extTypes = {}, typesModels = {}, errorCode = data.errorCode || 7, priority = [], modelSets = [];
                result = {};
                var extRegEx = [];
                for (var i in $p.mmap) {
                ...
                for (var index in data.file) {
                    if (data.file[index].type == modelSets[0].type || modelSets[0].type == "none/none") {
                        result = {setup: data.file, ID: this.randomId(8), type: data.file[index].type, ext: data.file[index].ext, file: (data.config.flashStreamType != "rtmp") ? this.toAbsoluteURL(data.file[index].src) : data.file[index].src, mediaModel: modelSets[0].model || "NA", errorCode: errorCode, config: data.config || {}};
                        break
                    }
                }
                return result
                ...
                switch (type) {
                    ...
                    case"scaled":
                        if (this.env.autoSize === true) {
                            this.env.playerDom.css({height: value.realHeight + "px", width: value.realWidth + "px"});
            ...
            this._enterFullViewport = function () {
                ...
                this.env.playerDom.css({position: "fixed", display: "block", top: 0, left: 0, width: "100%", height: "100%", zIndex: 99997});
            ...
            this._exitFullViewport = function () {
                ...
                if (this.getDC().width() != this.config._width || this.getDC().height() != this.config._height) {
                    this.getDC().css({width: this.config._width + "px", height: this.config._height + "px"})
                }
            ...
            this._enterIframeFullViewport = function () {
                ...
                var win = this.getIframeWindow(), iframe = this.getIframe();
                if (!win || !iframe) {
                    return
                }
                ...
                iframe.css({position: "fixed", display: "block", top: 0, left: 0, width: "100%", height: "100%", zIndex: 9999});
                this.env.inFullscreen = true
            };
            ...
            this.getConfig = function (name, itemIdx) {
                var idx = itemIdx || this._currentItem, result = undefined, playerCfg = (this.config["_" + name]) ? this.config["_" + name] : this.config[name];
            ...
            this.getMediaContainer = function () {
                ...
                if (this.env.mediaContainer.length == 0) {
                    if (this.env.playerDom.find("." + this.config._cssClassPrefix + "display").length > 0) {
                        this.env.mediaContainer = $(document.createElement("div")).attr({id: this.getId() + "_media"}).css({overflow: "hidden", height: "100%", width: "100%", top: 0, left: 0, padding: 0, margin: 0, display: "block"}).appendTo(this.env.playerDom.find("." + this.config._cssClassPrefix + "display"))
                    } else {
                        this.env.mediaContainer = $(document.createElement("div")).attr({id: this.getMediaId()}).css({width: "1px", height: "1px"}).appendTo($(document.body))
                    }
                }
            ...
            this.getFromUrl = function (url, dest, callback, customParser, dataType) {
                ...
                $.ajax({url: url, complete: function (xhr, status) {
                ...
                }, cache: true, dataType: dataType, jsonpCallback: (callback.substr(0, 1) != "_") ? false : "projekktor('" + this.getId() + "')._jsonp" + callback, jsonp: (callback.substr(0, 1) != "_") ? false : "callback"});
                return this
            };
            this.setActiveItem = function (mixedData) {
                ...
                this.playerModel._init({media: $.extend(true, {}, this.media[this._currentItem]), model: newModel, pp: this, environment: $.extend(true, {}, this.env), autoplay: ap});
                return this
            };
            ...
            this.setSize = function (data) {
                ...
                this.getDC().css({width: data.width + "px", height: data.height + "px"});
                this._modelUpdateListener("resize")
            };
            ...
            this.setFile = function (arg, ext, dataType) {
                var data = arg || {}, result = {}, externalData = ext || false;
                this._clearqueue();
                if (this.env.loading === true) {
                    return this
                }
            ...
            this.embeddFlash = function (destObj, domOptions) {
                var flashVars = domOptions.FlashVars || {}, result = "", htmlEmbedObj = "", htmlEmbed = "", tmpStr = "", id = "";
                domOptions.src += "?";
            ...
            this._testMediaSupport = function () {
                var nativeElementType = "", result = {all: [], media: []};
            ...
            this._raiseError = function (txt) {
                this.env.playerDom.html(txt).css({color: "#fdfdfd", backgroundColor: "#333", lineHeight: this.config.height + "px", textAlign: "center", display: "block"});
                this._promote("error")
            };
            this._readMediaTag = function (domNode) {
                ...
                result.playlist[0] = [];
                if (srcNode.attr("src")) {
                    result.playlist[0].push({src: srcNode.attr("src"), type: srcNode.attr("type") || this._getTypeFromFileExtension(srcNode.attr("src"))})
                }
                if ($.browser.msie && $.browser.version < 9) {
                    ...
                    do {
                        ...
                        if (childNode.attr("src")) {
                            result.playlist[0].push({src: childNode.attr("src"), type: childNode.attr("type") || this._getTypeFromFileExtension(childNode.attr("src"))})
                        }
                    } while (childNode.attr("src"))
                } else {
                    srcNode.children("source").each(function () {
                        if ($(this).attr("src")) {
                            result.playlist[0].push({src: $(this).attr("src"), type: $(this).attr("type") || ref._getTypeFromFileExtension($(this).attr("src"))})
                        }
                    })
                }
                try {
            ...
            this._applyDimensions = function () {
                ...
                this.env.playerDom.css({overflow: "hidden", width: this.config._width + "px", height: this.config._height + "px", "max-width": "100%"})
            };
            this._init = function (customNode, customCfg) {
                ...
                if (cfgBySource !== false) {
                    this.env.playerDom = $(document.createElement("div")).attr({"class": theNode[0].className, style: theNode.attr("style")});
                    theNode.replaceWith(this.env.playerDom)
                } else {
                    cfgBySource = {width: (theNode.attr("width")) ? theNode.attr("width") : theNode.width(), height: (theNode.attr("height")) ? theNode.attr("height") : theNode.height()};
            ...
            this._applyTheme = function (data) {
                ...
                if (typeof data.css == "string") {
                    $("head").append('<style type="text/css">' + this.parseTemplate(data.css, {rp: data.baseURL}) + "</style>")
                }
                if (typeof data.html == "string") {
                    this.env.playerDom.html(this.parseTemplate(data.html, {p: this.config._cssClassPrefix}))
                }
...
jQuery(function (b) {
    projekktorPluginInterface.prototype = {pluginReady: false, name: "", pp: {}, config: {}, playerDom: null, canvas: {media: null, projekktor: null}, _appliedDOMObj: [], _init: function (a) {
        ...
        this.pp._promote({_plugin: this.name, _event: a}, d)
...
jQuery(function (b) {
    playerModel.prototype = {modelId: "player", iLove: [], _currentState: null, _currentBufferState: null, _volume: 0, _KbPerSec: 0, _bandWidthTimer: null, _isPoster: false, modelReady: true, requiresFlash: false, hasGUI: false, allowRandomSeek: false, flashVerifyMethod: "api_get", elementReady: false, mediaElement: null, pp: {}, media: {duration: 0, position: 0, startOffset: 0, file: false, poster: "", ended: false, message: "", error: null, loadProgress: 0, errorCode: 0, message: "", type: "NA"}, _init: function (a) {
        ...
        var g = (f.position != undefined) ? f.position : f.currentTime, h = f.duration, a = (g > 0 && h > 0) ? g * 100 / h : 0;
        ...
        try {
            ...
            var a = Math.round(g.buffered.end(g.buffered.length - 1) * 100) / 100, h = a * 100 / this.media.duration;
        ...
        var h = this.pp.getMediaContainer(), i = this.pp.getConfig("messages"), j = (i[g] != undefined) ? i[g] : i[0];
        j = (a != undefined && a != "") ? a : j;
        ...
        j = this.pp.parseTemplate(j, b.extend({}, this.media, {flashver: this.requiresFlash}));
        h.css({width: "100%", height: "100%"}).html("");
        ...
        var h = b(document.createElement("img")).hide(), i = this;
        if (j == "" || j == undefined) {
            h = b(document.createElement("span")).attr({id: this.pp.getMediaId() + "_image"}).appendTo(l);
            return h
        }
        h.appendTo(l).attr({id: this.pp.getMediaId() + "_image", src: j}).css({position: "absolute"});
        h.error(function (c) {
            b(this).remove()
        });
        var a = function (c) {
        ...
        if (v._originalDimensions === undefined) {
            ...
            v._originalDimensions = {width: v.width(), height: v.height()}
        }
        ...
        v.css({margin: 0, padding: 0, width: a + "%", height: o + "%", left: (100 - a) / 2 + "%", top: (100 - o) / 2 + "%"});
        ...
        try {
            var l = m.width(), e = m.height(), a = this.videoWidth, n = this.videoHeight;
            if (this.stretch(this.pp.getConfig("videoScaling"), this.mediaElement, l, e, a, n)) {
                this.sendUpdate("scaled", {realWidth: a, realHeight: n, displayWidth: l, displayHeight: e})
            }
        } catch (k) {
        }
    }}
...
jQuery(function (b) {
    $p.newModel({modelId: "NA", iLove: [
        {ext: "NaN", type: "none/none", platform: "all"}
    ], hasGUI: true, applyMedia: function (a) {
...
jQuery(function (b) {
    $p.newModel({modelId: "PLAYLIST", iLove: [
...
jQuery(function (b) {
    $p.newModel({modelId: "VIDEOFLASH", iLove: [
    ...
    ], requiresFlash: 9, allowRandomSeek: false, flashVerifyMethod: "api_get", _jarisVolume: 0, applyMedia: function (a) {
        var d = {id: this.pp.getMediaId() + "_flash", name: this.pp.getMediaId() + "_flash", src: this.pp.getConfig("playerFlashMP4"), width: "100%", height: "100%", allowScriptAccess: "always", allowFullScreen: "true", allowNetworking: "all", wmode: "transparent", bgcolor: "#000000", FlashVars: {source: this.media.file, type: "video", streamtype: this.pp.getConfig("flashStreamType"), server: (this.pp.getConfig("flashStreamType") == "rtmp") ? this.pp.getConfig("flashRTMPServer") : "", autostart: "false", hardwarescaling: "true", controls: "false", jsapi: "true"}};
    ...
    $p.newModel({modelId: "AUDIOFLASH", iLove: [
...
jQuery(function (b) {
    $p.newModel({modelId: "VIDEO", iLove: [
    ...
    ], allowRandomSeek: false, videoWidth: 0, videoHeight: 0, element: "video", init: function (a) {
        ...
        a.append(b(document.createElement(this.element)).attr({id: this.pp.getMediaId() + "_html", poster: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABBJREFUeNpi/v//PwNAgAEACQsDAUdpTjcAAAAASUVORK5CYII=", loop: false, autoplay: true, "x-webkit-airplay": "allow"}).prop({controls: (this.hasGUI && this.element == "video"), volume: this.getVolume()}).css({width: ((this.element == "video") ? "100%" : "1px"), height: ((this.element == "video") ? "100%" : "1px"), position: "absolute", top: 0, left: 0}));
        this.mediaElement = b("#" + this.pp.getMediaId() + "_html");
        for (var f in this.media.setup) {
            if (this.media.setup[f].src) {
                b(document.createElement("source")).appendTo(this.mediaElement).attr({src: this.media.setup[f].src, type: this.media.setup[f].type})
            }
        }
        this.waitforPlayer()
        ...
        var e = this, f = b("#" + this.pp.getMediaId() + "_html");
        try {
            if (f == undefined) {
                setTimeout(function () {
                    e.waitforPlayer()
        ...
        var a = this, d = this.mediaElement[0];
        if (this.getState() == "PLAYING") {
...
jQuery(function (b) {
    $p.newModel({modelId: "IMAGE", iLove: [
        ...
        if (this._duration > 0) {
            this._interval = setInterval(function () {
                ...
                a.timeListener({duration: a._duration, position: a._position})
            }, 500)
        } else {
            a._setState("completed")
        }
    ...
    $p.newModel({modelId: "HTML", iLove: [
        {ext: "html", type: "text/html", platform: "all"}
    ], applyMedia: function (d) {
        var a = this;
        this.mediaElement = b(document.createElement("iframe")).attr({id: this.pp.getMediaId() + "_iframe", name: this.pp.getMediaId() + "_iframe", src: this.media.file, scrolling: "no", frameborder: "0", width: "100%", height: "100%"}).css({overflow: "hidden", border: "0px", width: "100%", height: "100%"}).appendTo(d);
...
jQuery(function (b) {
    $p.newModel({modelId: "YTVIDEO", iLove: [
        {ext: "youtube.com", type: "video/youtube", platform: "flash", fixed: true}
    ], modelReady: false, allowRandomSeek: true, useIframeAPI: true, _updateTimer: null, init: function (f) {
        var a = this;
        ...
        var a = this;
        if (this.useIframeAPI === true) {
            this.mediaElement = new YT.Player(this.pp.getId() + "_media", {width: (this.pp.getIsMobileClient()) ? this.pp.config._width : "100%", height: (this.pp.getIsMobileClient()) ? this.pp.config._height : "100%", playerVars: {autoplay: 0, disablekb: 1, start: 0, controls: 0, enablejsapi: 1, wmode: "opaque"}, videoId: this.youtubeGetId(), events: {onReady: function (c) {
                a.onReady(c)
            ...
            b(this.mediaElement.a).prop("ALLOWTRANSPARENCY", true).attr({scrolling: "no", frameborder: 0}).css({overflow: "hidden", border: "0px", display: "block"});
            if (b.browser.mozilla) {
                this.requiresFlash = 8
            }
        } else {
            var e = {id: this.pp.getId() + "_media_youtube", name: this.pp.getId() + "_media_youtube", src: "http://www.youtube.com/apiplayer", width: "100%", height: "100%", bgcolor: "#000000", allowScriptAccess: "always", wmode: "transparent", FlashVars: {enablejsapi: 1, autoplay: 1}};
            this.createFlash(e, f)
        }
    }, flashReadyListener: function () {
        ...
        b(this.mediaElement).attr({width: "99.99999%", height: "99.9999%"});
        this.applyCommand("volume", this.pp.getConfig("volume"))
    }, addListeners: function () {
        if (this.useIframeAPI === true) {
            return
        ...
        var a = this;
        b.ajax({url: "http://gdata.youtube.com/feeds/api/videos/" + this.youtubeGetId() + "?v=2&alt=jsonc", complete: function (e, h) {
            try {
                data = e.responseText;
                if (typeof data == "string") {
                ...
                if (data.data.title) {
                    a.sendUpdate("config", {title: data.data.title + " (" + data.data.uploader + ")"})
                }
            } catch (g) {
            }
            a.elementReady = true
        ...
        (function () {
            ...
            try {
                if (a.getState() !== "IDLE" && a.getState() !== "COMPLETED") {
                    a.timeListener({position: a.mediaElement.getCurrentTime(), duration: a.mediaElement.getDuration()});
                    a.progressListener({loaded: a.mediaElement.getVideoBytesLoaded(), total: a.mediaElement.getVideoBytesTotal()})
                }
            } catch (d) {
            }
...
jQuery(function (b) {
    projekktorControlbar.prototype = {_cTimer: null, _noCHide: false, _cFading: false, _vSliderAct: false, _storeVol: 0, _timeTags: {}, cb: null, cbFS: null, _pos: {left: 0, right: 0}, controlElements: {}, controlElementsConfig: {cb: null, playhead: {on: null, call: null}, loaded: {on: "click", call: "scrubberClk"}, scrubber: {on: "click", call: "scrubberClk"}, play: {on: "click", call: "playClk"}, pause: {on: "click", call: "pauseClk"}, stop: {on: "click", call: "stopClk"}, prev: {on: "click", call: "prevClk"}, next: {on: "click", call: "nextClk"}, rewind: {on: "click", call: "rewindClk"}, forward: {on: "click", call: "forwardClk"}, fsexit: {on: "click", call: "exitFullscreenClk"}, fsenter: {on: "click", call: "enterFullscreenClk"}, vslider: {on: "click", call: "vsliderClk"}, vmarker: {on: "click", call: "vsliderClk"}, vknob: {on: "mousedown", call: "vknobStartDragListener"}, mute: {on: "click", call: "muteClk"}, unmute: {on: "click", call: "unmuteClk"}, vmax: {on: "click", call: "vmaxClk"}, open: {on: "click", call: "openCloseClk"}, close: {on: "click", call: "openCloseClk"}, loopon: {on: "click", call: "loopClk"}, loopoff: {on: "click", call: "loopClk"}, draghandle: {on: "mousedown", call: "handleStartDragListener"}, controls: {on: null, call: null}, title: null, sec_dur: null, min_dur: null, hr_dur: null, sec_elp: null, min_elp: null, hr_elp: null, sec_rem: null, min_rem: null, hr_rem: null}, config: {disableFade: false, fadeDelay: 2500, showOnStart: false, controlsTemplate: "<div %{fsexit}></div><div %{fsenter}></div><div %{play}></div><div %{pause}></div><div %{prev}></div><div %{next}></div><div %{title}></div><div %{timeleft}>%{min_elp}:%{sec_elp} | %{min_dur}:%{sec_dur}</div><div %{scrubber}><div %{loaded}></div><div %{playhead}></div></div><div %{vslider}><div %{vmarker}></div><div %{vknob}></div></div><div %{mute}></div><div %{vmax}></div>", controlsTemplateFull: null, toggleMute: false}, initialize: function () {
        ...
        var h = this, g = this.getConfig("cssClassPrefix");
        if (j) {
        ...
        var a = this, f = this.getConfig("cssClassPrefix");
        this._noCHide = false;
        this._cFading = false;
        ...
        clearTimeout(this._cTimer);
        var f = this.getConfig("cssClassPrefix"), a = (this.pp.getInFullscreen() === true) ? this.cbFS : this.cb, g = this;
        if (a == null) {
            return
        }
        a.stop(true, true);
        ...
        var g = this, a = (this.pp.getInFullscreen() === true) ? this.cbFS : this.cb, f = this.getConfig("cssClassPrefix");
        if (a == null) {
            return
        }
        ...
        try {
            var p = (n != undefined) ? n : this.pp.getLoadPlaybackProgress(), k = (o != undefined) ? o : this.pp.getDuration(), a = (e != undefined) ? e : this.pp.getPosition()
        } catch (m) {
            var p = n || 0, k = o || 0, a = e || 0
        }
        ...
        clearTimeout(this._cTimer);
        var m = (this.pp.getInFullscreen() === true) ? this.cbFS : this.cb, j = m.is(":visible"), k = this, n = (this.controlElements.mute.hasClass("toggle") || this.controlElements.unmute.hasClass("toggle") || this.getConfig("toggleMute")), l = m.find("." + this.getConfig("cssClassPrefix") + "vknob"), i = m.find("." + this.getConfig("cssClassPrefix") + "vslider");
        ...
        var h = (this.pp.getInFullscreen() === true && this.controlElements.vslider.length > 1) ? 1 : 0, k = b(this.controlElements.scrubber[h]).width(), l = b(this.controlElements.loaded[h]).width(), i = a.pageX - b(this.controlElements.scrubber[h]).offset().left;
        ...
        var g = (this.pp.getInFullscreen() === true && this.controlElements.vslider.length > 1) ? 1 : 0, a = b(this.controlElements.vslider[g]), i = a.width(), h = j.pageX - a.offset().left;
        ...
        var r = this, p = (this.pp.getInFullscreen() === true && this.controlElements.vslider.length > 1) ? 1 : 0, s = b(m[p]), n = b(this.controlElements.vslider[p]), a = Math.abs(parseInt(s.position().left) - t.clientX), q = 0, o = function (c) {
            if (b.browser.msie) {
                c.cancelBubble = true
            } else {
                c.stopPropagation()
...
jQuery(function (b) {
    projekktorDisplay.prototype = {logo: null, logoIsFading: false, display: null, displayClicks: 0, buffIcn: null, buffIcnSprite: null, bufferDelayTimer: null, bufferIconDelay: 1, config: {onclick: {callback: "setPlayPause", value: null}, onclick_playing: {callback: "setPlayPause", value: null}, ondblclick: {callback: "setFullscreen", value: null}, bufferIconDelay: 200, spriteUrl: "", spriteWidth: 50, spriteHeight: 50, spriteTiles: 25, spriteOffset: 1, spriteCountUp: false, logoImage: "", logoDelay: 0, logoPosition: "tl", onlogoclick: {callback: "", value: {url: "", target: "_blank", pause: true}}}, initialize: function () {
        var d = this;
        var a = {position: "absolute", overflow: "hidden", height: "100%", width: "100%", top: 0, left: 0, padding: 0, margin: 0, display: "block"};
        ...
        if (this.config.spriteUrl != "") {
            this.buffIcnSprite = b(document.createElement("div")).appendTo(this.buffIcn).css({width: this.config.spriteWidth, height: this.config.spriteHeight, marginLeft: ((this.buffIcn.width() - this.config.spriteWidth) / 2) + "px", marginTop: ((this.buffIcn.height() - this.config.spriteHeight) / 2) + "px", backgroundColor: "transparent", backgroundImage: "url(" + this.config.spriteUrl + ")", backgroundRepeat: "no-repeat", backgroundPosition: "0 0"}).addClass("inactive")
        }
        ...
        if (this.getConfig("logoImage") != false) {
            this.logo.attr("src", this.getConfig("logoImage")).css({cursor: (this.getConfig("logoURL") != "") ? "pointer" : "normal"}).click(function () {
                try {
        ...
        var a = this.pp.getPosition(), e = this.pp.getDuration(), f = this;
...
(function (d) {
    ...
    d.pixelentity.video = {conf: {disableFade: false, useVideoTag: false}, getType: function (f) {
        return"video/" + f.match(/(\w+)$/)[1].replace("ogv", "ogg")
    }, fallbackPlayer: "js/template/video/jarisplayer.swf", SimplePlayer: b};
    ...
    function c(v, n) {
        ...
        function i(y, A) {
            ...
            if (n.useVideoTag) {
                ...
                m.html(t[0]);
                r = new projekktor("#" + z, {disableFade: n.disableFade, controls: true, volume: 0.9, _width: n.width, _height: n.height, _autoplay: true, enableFullscreen: false, imageScaling: "fill", videoScaling: "aspectratio", poster: A, playerFlashMP4: d.pixelentity.video.fallbackPlayer, playerFlashMP3: d.pixelentity.video.fallbackPlayer, playlist: [x]})
            }
        ...
        function k(t) {
            var w = d("<div/>");
            m.append(w);
            r = new t(w[0], {height: n.height, width: n.width, videoId: n.videoId, playerVars: {theme: "dark", wmode: "opaque", autohide: 1, enablejsapi: 1, origin: location.href.match(/:\/\/(.[^\/]+)/)[1], loop: n.loop ? 1 : 0, hd: n.hd ? 1 : 0, autoplay: n.autoPlay ? 1 : 0, showinfo: 0, iv_load_policy: 3, modestbranding: 1, showsearch: 0, fs: 0}, events: {onStateChange: u, onReady: q}});
            s = setInterval(u, 250);
        ...
        d.extend(this, {resize: h, bind: function (w, t) {
            l.bind(w, t)
        }, unbind: function (w, t) {
            l.bind(w, t)
        }, one: function (w, t) {
...
(function () {
    var b = "h";
    var c = [0, -1631451101, -1486014414, -738455326, 2092482289];
...
(function (f) {
    ...
    var g = [];
    var d = {vidly: /http:\/\/(vid.ly)\/([\w|\-]+)/i, youtube: /http:\/\/(www.youtube.com\/watch\?v=|youtube.com\/watch\?v=|youtu.be\/)([\w|\-]+)/i, vimeo: /http:\/\/(vimeo\.com|www\.vimeo\.com)\/([\w|\-]+)/i};
    var c = {vidly: "http://cf.cdn.vid.ly/$ID/poster.jpg", youtube: "http://img.youtube.com/vi/$ID/0.jpg", vimeo: "http://vimeo.com/api/v2/video/$ID.json?callback=?"};
    ...
    function e(C, m) {
        ...
        f.extend(this, {enable: o, disable: i, destroy: function () {
            if (y && y.destroy) {
                y.destroy()
            }
            y = undefined;
...
(function (e) {
    ...
    var c = document.createElement("modernizr"), d = c.style;
    ...
    var a = i(), g = a !== null ? a + "transform" : false, h = a !== null ? a + "transform-origin" : false;
    ...
    function b(o, s, z, y, v, q, x, p) {
        if (e.support.csstransforms && !p) {
            ...
            if (!x && !p && e.browser.msie) {
                ...
                e(o).width(v * s).height(q * s).css({"margin-left": z + "px", "margin-top": y + "px"})
            }
        }
    }
...
(function (d) {
    d.pixelentity = d.pixelentity || {version: "1.0.0"};
    d.pixelentity.peFlareLightbox = {conf: {api: false}};
    ...
    function e() {
        ...
        function aH(h) {
            ...
            if (aI) {
                ...
                w.animate({"margin-top": (af ? -84 : 0)}, 500)
            }
        }
        ...
        function ah() {
            ...
            if (d.pixelentity.browser.iDev && (j.videoType == "vimeo" || j.videoType == "youtube")) {
                m = true;
                aB.css({position: "absolute", top: W.scrollTop()})
            }
        }
        ...
        function aa() {
            ...
            aO = x.peVideo({api: true, useVideoTag: d.pixelentity.browser.mobile, disableFade: true, width: P, height: X, type: j.videoType, videoId: j.video, poster: d.pixelentity.browser.mobile && j.videoPoster, hd: true, autoPlay: true, loop: false});
        ...
        function r(aT) {
            ...
            if (w.isGallery) {
                ...
                if (n) {
                    ...
                    h.css("opacity", 0).animate({left: f[aD].to, opacity: 1}, 1000)
                }
            }
            if (d.inArray(w, au) < 0) {
                au.push(w)
        ...
        function E() {
            ...
            while ((w = au.shift())) {
                if (aI) {
                    ...
                    w.render().css("opacity", 1).animate({left: -f[aD].from, opacity: 0}, 1000, null, w.destroy)
                }
            }
        }
        ...
        function C(aV) {
            ...
            var h = {id: aW, plugin: w, resource: aT || "", gallery: aV.attr("data-flare-gallery") || false, bw: aV.attr("data-flare-bw"), thumb: aV.attr("data-flare-thumb"), scale: aV.attr("data-flare-scale") || "fit"};
            if (aU.video) {
                d.extend(h, aU)
            }
            k.push(aV);
        ...
        d.extend(this, {init: am, add: C, show: r, signal: p, register: aN, addToBuffer: A})
    }
    ...
    function a(i, h) {
        ...
        d.extend(this, {destroy: function () {
...
(function (a) {
    a.pixelentity = a.pixelentity || {version: "1.0.0"};
    a.pixelentity.peBackgroundSlider = {conf: {api: false, wait: false}};
    function b(E, k) {
        var x, n, s, p;
        var o = a(this);
        var e = 0;
        ...
        a.extend(this, {load: j, resize: B, gogo: l, bind: G, unbind: i, configure: D, destroy: A});
        g()
    }
...
(function (b) {
    ...
    function a(f, e) {
        ...
        b.extend(this, {destroy: function () {
