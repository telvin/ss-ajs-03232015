				...
				$this.clearQueue().delay(object.options.delay).queue(function() {
					...
					object.options.functionBefore($this, function() {
						...
						// if the tooltip isn't already open, open that sucker up!
                            ...
                            var maxHeight = object.options.maxHeight > 0 ? 'max-height:'+ object.options.maxHeight +'px;' : '';
							var pointerEvents = object.options.interactive == true ? 'pointer-events: auto;' : '';
												
							// build the base of our tooltip
							var tooltipster = $('<div class="tooltipster-base '+ themeClass +' '+ animation +'" style="'+ fixedWidth +' '+ maxWidth +' '+ maxHeight +' '+ pointerEvents +' '+ animationSpeed +' overflow:hidden"><div class="tooltipster-content">'+content+'</div></div>');
