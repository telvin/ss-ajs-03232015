"undefined" == typeof jwplayer && (jwplayer = function (f) {
    ...
    var a = f.loaderstatus = {NEW: 0, LOADING: 1, ERROR: 2, COMPLETE: 3}, k = document;
    f.scriptloader = function (e) {
        ...
        this.load = function () {
            ...
            if (h && (h.getStatus() ==
                a.NEW || h.getStatus() == a.LOADING))h.addEventListener(n.ERROR, c), h.addEventListener(n.COMPLETE, b); else if (f.scriptloader.loaders[e] = this, d == a.NEW) {
                d = a.LOADING;
    ...
    var k = {code: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode: function (a, b) {
    ...
    f.events = {COMPLETE: "COMPLETE", ERROR: "ERROR", API_READY: "jwplayerAPIReady", JWPLAYER_READY: "jwplayerReady", JWPLAYER_FULLSCREEN: "jwplayerFullscreen", JWPLAYER_RESIZE: "jwplayerResize", JWPLAYER_ERROR: "jwplayerError", JWPLAYER_SETUP_ERROR: "jwplayerSetupError", JWPLAYER_MEDIA_BEFOREPLAY: "jwplayerMediaBeforePlay",
    ...
    f.eventdispatcher = function (f, e) {
        ...
        this.addEventListener = function (b, e, h) {
            try {
                a.exists(c[b]) || (c[b] = []), "string" == a.typeOf(e) && (e = (new Function("return " + e))()), c[b].push({listener: e, count: h})
            } catch (f) {
                a.log("error", f)
            }
            return!1
        ...
        this.addGlobalListener = function (d, c) {
            try {
                "string" == a.typeOf(d) && (d = (new Function("return " + d))()), b.push({listener: d, count: c})
            } catch (e) {
                a.log("error", e)
            }
            return!1
        ...
        this.sendEvent = function (d, n) {
            a.exists(n) || (n = {});
            a.extend(n, {id: f, version: jwplayer.version, type: d});
            e && a.log(d, n);
    ...
    f.plugin = function (e) {
        ...
        a.extend(this, j);
        this.load = function () {
            if (n == a.loaderstatus.NEW)if (0 < e.lastIndexOf(".swf"))h = e, n = a.loaderstatus.COMPLETE, j.sendEvent(k.COMPLETE); else if (a.getPluginPathType(e) == a.pluginPathType.CDN)n = a.loaderstatus.COMPLETE,
                j.sendEvent(k.COMPLETE); else {
    ...
    function (f) {
        ...
        f.plugins.pluginloader = function (c, b) {
            function d() {
                p ? g.sendEvent(k.ERROR, {message: q}) : r || (r = !0, h = a.loaderstatus.COMPLETE, g.sendEvent(k.COMPLETE))
            }
            ...
            function n() {
                ...
                if (!r && !p) {
                    ...
                    a.foreach(j, function (c) {
                        ...
                        if (g == a.loaderstatus.LOADING || g == a.loaderstatus.NEW)b++; else if (c && (!h || parseFloat(h) > parseFloat(f.version)))p = !0, q = "Incompatible player version", d()
                    });
                    0 == b && d()
                }
            }
            ...
            this.setupPlugins = function (b, d, g) {
                var h = {length: 0, plugins: {}}, m = 0, f = {}, j = c.getPlugins();
    ...
    var a = f.utils, k = f.events, e = !0, c =
        ...
        function g(a, b) {
            ...
            n.dispatchEvent(k.JWPLAYER_SETUP_ERROR, {message: a, fallback: b})
        }
        ...
        y.addEventListener(k.COMPLETE, function () {
            ...
            if ("array" == a.typeOf(m.playlist) && 2 > m.playlist.length && (0 == m.playlist.length || !m.playlist[0].sources ||
                0 == m.playlist[0].sources.length))p(); else if (y.getStatus() == a.loaderstatus.COMPLETE) {
    ...
    function a(a) {
        if (a.playlist)for (var d = 0; d < a.playlist.length; d++)a.playlist[d] = new c(a.playlist[d]); else {
            var f = {};
    ...
    (f.embed.config = function (b) {
        var d = {fallback: !0, height: 270, primary: "html5", width: 480, base: b.base ? b.base : e.getScriptPath("jwplayer.js"), aspectratio: ""};
        b = e.extend(d, f.defaults, b);
        var d = {type: "html5", src: b.base + "jwplayer.html5.js"}, c = {type: "flash", src: b.base + "jwplayer.flash.swf"};
        ...
        a(b);
        c = b.aspectratio;
        if ("string" != typeof c || !e.exists(c))d = 0; else {
            var h = c.indexOf(":");
    ...
    f.embed.download = function (e, c, b) {
        ...
        c = c.logo ? c.logo : {prefix: a.repo(), file: "logo.png", margin: 10};
        ...
        if (h && h.length) {
            ...
            j ? (q = j, b = g, e && (h = f("a", "display", e), f("div", "icon", h), f("div", "logo", h), q && h.setAttribute("href", a.getAbsolutePath(q))), h = "#" + e.id + " .jwdownload", e.style.width = "", e.style.height = "", d(h + "display", {width: a.styleDimension(Math.max(320, r)), height: a.styleDimension(Math.max(180, p)), background: "black center no-repeat " + (b ? "url(" + b + ")" : ""), backgroundSize: "contain", position: "relative", border: "none", display: "block"}), d(h + "display div", {position: "absolute", width: "100%", height: "100%"}), d(h + "logo",
    ...
    (f.embed.flash = function (c, b, d, n, h) {
        ...
        this.embed = function () {
            d.id = h.id;
            if (10 > g)return j.sendEvent(k.ERROR, {message: "Flash version must be 10.0 or greater"}),
                !1;
            var f, l, t = h.config.listbar, u = a.extend({}, d);
            if (c.id + "_wrapper" == c.parentNode.id)f = document.getElementById(c.id + "_wrapper"); else {
                ...
                try {
                    ...
                    for (var c = 0; c < b.length; c++) {
                        ...
                        if (e = b[c].file) {
                            ...
                            if (a.isYouTube(f) || a.isRtmp(f, h) || "hls" == h)e = !0; else {
        ...
        q.supportsConfig = function () {
            if (f.vid.canPlayType)try {
                ...
                for (var b = d.playlist[0].sources, c = 0; c < b.length; c++) {
                    ...
                    if (null !== navigator.userAgent.match(/BlackBerry/i) || a.isAndroid() && ("m3u" == a.extension(h) || "m3u8" == a.extension(h)) || a.isRtmp(h, j))e = !1; else {
        ...
        c = e.state, b = document, d = f.api = function (a) {
            ...
            function r(a, b) {
                l[a] || (l[a] = [], q(e.JWPLAYER_PLAYER_STATE, function (b) {
                    ...
                    if (c == a) {
                        var d = l[c];
                        if (d)for (var e = 0; e < d.length; e++)"function" == typeof d[e] && d[e].call(this, {oldstate: b, newstate: c})
                    }
                }));
                l[a].push(b);
                return g
            ...
            var x = {onBufferChange: e.JWPLAYER_MEDIA_BUFFER, onBufferFull: e.JWPLAYER_MEDIA_BUFFER_FULL, onError: e.JWPLAYER_ERROR, onSetupError: e.JWPLAYER_SETUP_ERROR, onFullscreen: e.JWPLAYER_FULLSCREEN, onMeta: e.JWPLAYER_MEDIA_META,
                ...
                onQualityChange: e.JWPLAYER_MEDIA_LEVEL_CHANGED, onCaptionsList: e.JWPLAYER_CAPTIONS_LIST, onCaptionsChange: e.JWPLAYER_CAPTIONS_CHANGED, onAdError: e.JWPLAYER_AD_ERROR, onAdClick: e.JWPLAYER_AD_CLICK, onAdImpression: e.JWPLAYER_AD_IMPRESSION, onAdTime: e.JWPLAYER_AD_TIME, onAdComplete: e.JWPLAYER_AD_COMPLETE, onAdCompanions: e.JWPLAYER_AD_COMPANIONS};
            k.foreach(x, function (a) {
                g[a] = h(x[a], q)
            });
            var v = {onBuffer: c.BUFFERING, onPause: c.PAUSED, onPlay: c.PLAYING, onIdle: c.IDLE};
    ...
    f.api.instream = function (c, b, d, f) {
        ...
        function r(b, c) {
            g[b] || (g[b] = [], h(a.JWPLAYER_PLAYER_STATE, function (a) {
                ...
                if (c == b) {
                    var e = g[c];
                    if (e)for (var f = 0; f < e.length; f++)"function" == typeof e[f] && e[f].call(this, {oldstate: d, newstate: c, type: a.type})
                }
            }));
            g[b].push(c);
            return this
    ...
    a.selectPlayer = function (a) {
        return(a = k(a)) ? a : {registerPlugin: function (a, b, d) {
