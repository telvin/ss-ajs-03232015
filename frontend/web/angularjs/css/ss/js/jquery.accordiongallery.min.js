...
(function (a) {
    a.fn.accordionGallery = function (b) {
        b = a.extend({theme:"air", maxHeight:360, scrollSpeed:2E3, minSliceWidth:100, maxSliceWidth:500, maxSliceHeight:480}, b);
            ...
            v.each(function () {
                ...
                var e = function () {
                    ...
                    var f = a(".accordiongallery-thumbs", c), q = function () {
                        ...
                        e.$scroller.stop().animate({top:0}, b.scrollSpeed)
                    }, d = function () {
                        e.$scroller.stop().animate({top:b.maxHeight - e.$scroller.height()}, b.scrollSpeed)
                    };
                    if (f.height() > b.maxHeight) {
                        f.height(b.maxHeight).wrapInner('<div class="accordiongallery-scroller" />');
                        var h = a(".accordiongallery-scroller",
                            c);
                    ...
                    return{$scroller:h, $container:f, $scrollup:k, $scrolldown:l, $items:g}
                }(), u = function () {
                    var g =
                        v.not(c), f = {}, q = function () {
                        var d = new Image;
                        d.src = f.url;
                        var h = '<img src="' + d.src + '" ';
                        ...
                        h += k + l;
                        h = '<p class="accordiongallery-loader">Loading... </p><div class="accordiongallery-preview" style="visibility: hidden; opacity: 0">' + h + "</div>";
                        c.append(h);
                        ...
                        p.text() || p.hide();
                        var n = a(".accordiongallery-preview-scroller",
                            i), w = n.find("a").outerWidth(true) * n.find("a").length;
                        n.width(w);
                        var x = function (j) {
                            s.css({visibility:"hidden", opacity:0});
                        ...
                        if (w > t.width()) {
                            ...
                            h.hover(function () {
                                    n.stop().animate({left:0}, b.scrollSpeed)
                                },
                                d);
                            k.hover(function () {
                                n.stop().animate({left:t.outerWidth() - n.outerWidth()}, b.scrollSpeed)
                            }, d);
                        ...
                        l.click(function () {
                            ...
                            var y = function (z) {
                                if (z == true) {
                                    ...
                                    o.attr({src:j.src, title:j.title, alt:j.title});
                                    if (j.title) {
                                        p.show();
                                        if(data != "")
                                        {
                                            p.html("<a href=\"" + data + "\">" + j.title + "</a>");
                                        }else
                                        {
                                            p.html(j.title);
                                        }
                    ...
                    return{init:function () {
                        ...
                        if (jQuery.support.transition) {
                            c.css({width:b.maxSliceWidth, height:b.maxSliceHeight});
                            g.each(function () {
                                a(this).css({width:b.minSliceWidth, height:a(this).attr("data-originalheight") * 1})
                            })
                        } else {
                            c.stop().animate({width:b.maxSliceWidth, height:b.maxSliceHeight}, 300);
                            g.each(function () {
                                a(this).stop().animate({width:b.minSliceWidth,
                                    height:a(this).attr("data-originalheight")}, 300)
                            })
                        }
                        $startedLoader = a(".accordiongallery-loader", g);
                        $startedLoader.css({visibility:"hidden", opacity:0});
                        c.unbind("click");
                        g.click(u.close);
                        q();
                        return false
                        ...
                        if (jQuery.support.transition) {
                            c.css({width:m, height:c.attr("data-originalheight") *
                                1});
                            g.each(function () {
                                a(this).css({width:m, height:a(this).attr("data-originalheight") * 1})
                            })
                        } else {
                            c.stop().animate({width:m, height:c.attr("data-originalheight")}, 300);
                            g.each(function () {
                                a(this).stop().animate({width:m, height:a(this).attr("data-originalheight")}, 300)
                            })
                        }
                        g.unbind("click")
                    }}
