...
;(function($){
    $.fn.pgwSlideshow = function(options) {
        ...
        var finishElement = function(element) {
            ...
            if(maxHeight == null)
                maxHeight = pgwSlideshow.plugin.find('.ps-current .elt_' + element.id + ' iframe').height();
            //console.log(pgwSlideshow.plugin.find('.ps-current .elt_' + element.id + ' img').clone().wrap('<div>').parent().html());
