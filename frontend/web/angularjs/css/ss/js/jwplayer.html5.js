...
(function (f) {
        ...
        function (a) {
            ...
            if (a) {
                ...
                for (var g = 0; g < a.length; g++) {
                    var d = a[g].type, h = a[g].file;
                    d || (d = e.extType(f.extension(h)), a[g].type = d);
    ...
    f.canPlayHTML5 = function (a) {
        if (f.isAndroid() && ("hls" == a || "m3u" == a || "m3u8" == a))return!1;
    ...
    f.ajax = function (a, b, c) {
        ...
        var g;
        g = (g = a) && 0 <= g.indexOf("://") && g.split("/")[2] != d.location.href.split("/")[2] ?
            !0 : !1;
        if (g && f.exists(d.XDomainRequest))k = new XDomainRequest, k.onload = e(k, a, b, c), k.onerror = h(c, a, k); else if (f.exists(d.XMLHttpRequest)) {
            var r = k = new XMLHttpRequest, l = a;
            k.onreadystatechange = function () {
                if (4 === r.readyState)switch (r.status) {
                    case 200:
                        e(r, l, b, c)();
                        break;
                    case 404:
    ...
    f.parseXML = function (a) {
        try {
            ...
            if (d.DOMParser) {
                ...
                try {
                    if ("parsererror" ==
                        b.childNodes[0].firstChild.nodeName)return
                } catch (c) {
                }
    ...
    f.bounds = function (a) {
        if (!a)return{left: 0, right: 0, width: 0, height: 0, top: 0, bottom: 0};
        var b = a, c = 0, e = 0, g = isNaN(a.offsetWidth) ? 0 : a.offsetWidth;
        a = isNaN(a.offsetHeight) ? 0 : a.offsetHeight;
        do c +=
            isNaN(b.offsetLeft) ? 0 : b.offsetLeft, e += isNaN(b.offsetTop) ? 0 : b.offsetTop; while (b = b.offsetParent);
        return{left: c, top: e, width: g, height: a, right: c + g, bottom: e + a}
    };
    f.empty = function (a) {
        if (a)for (; 0 < a.childElementCount;)a.removeChild(a.children[0])
    }
})(jwplayer.utils);
(function (f) {
    function h() {
    ...
    function e(b) {
        if (j)a[b].innerHTML = d(b); else {
            var g = a[b].sheet, c = l[b];
            if (g) {
                var e = g.cssRules;
                f.exists(c) && c < e.length && e[c].selectorText == b ? g.deleteRule(c) : l[b] = e.length;
                g.insertRule(d(b), l[b])
            }
        }
    }
    ...
    var a = {}, b, c = {}, k = 0, g = f.exists, r = f.foreach, l = {}, j = !1, q = f.css = function (d, p, l) {
        if (!a[d])if (j)a[d] = h(); else {
        ...
        r(p, function (a, b) {
            a:{
                var e = b;
                if ("undefined" === typeof e)b = void 0; else {
                    var k = l ? " !important" : "";
                    if (isNaN(e))b = e.match(/png|gif|jpe?g/i) && 0 > e.indexOf("url") ? "url(" + e + ")" : e + k; else switch (a) {
                        case "z-index":
                        case "opacity":
                            b = e + k;
                            break a;
    ...
    f.transform = function (a, b) {
        var g = "-transform", e;
        b = b ? b : "";
        "string" == typeof a ? (e = {}, e["-webkit" + g] = b, e["-ms" + g] = b, e["-moz" + g] = b, e["-o" + g] = b, f.css(a, e)) : (g = "Transform", e = a.style, e["webkit" + g] = b, e["Moz" + g] = b, e["ms" + g] = b, e["O" + g] = b)
    };
    f.dragStyle = function (a, b) {
        f.css(a, {"-webkit-user-select": b,
            "-moz-user-select": b, "-ms-user-select": b, "-webkit-user-drag": b, "user-select": b, "user-drag": b})
    };
    f.transitionStyle = function (b, a) {
        navigator.userAgent.match(/5\.\d(\.\d)? safari/i) || f.css(b, {"-webkit-transition": a, "-moz-transition": a, "-o-transition": a})
    };
    f.rotate = function (b, a) {
        f.transform(b, "rotate(" + a + "deg)")
    };
    q(".jwplayer " + " div span a img ul li video".split(" ").join(",.jwplayer ") + ", .jwclick", {margin: 0, padding: 0, border: 0, color: "#000000", "font-size": "100%", font: "inherit", "vertical-align": "baseline",
        "background-color": "transparent", "text-align": "left", direction: "ltr"});
...
(function (f) {
    ...
    f.stretch = function (e, d, a, b, c, k) {
        if (d && (e || (e = h.UNIFORM), a && b && c && k)) {
            var g = a / c, r = b / k, l = "video" == d.tagName.toLowerCase(), j = !1, q;
            l && f.transform(d);
            q = "jw" + e.toLowerCase();
            switch (e.toLowerCase()) {
                ...
                case h.EXACTFIT:
                    ...
                    break;
                default:
                    g > r ? 0.95 < c * r / a ? (j = !0, q =
                        "jwexactfit") : (c *= r, k *= r) : 0.95 < k * g / b ? (j = !0, q = "jwexactfit") : (c *= g, k *= g), j && (r = Math.ceil(100 * b / k) / 100, g = Math.ceil(100 * a / c) / 100)
            }
            l ? j ? (d.style.width = c + "px", d.style.height = k + "px", f.scale(d, g, r, (a - c) / 2 / g, (b - k) / 2 / r)) : (d.style.width = "", d.style.height = "") : (d.className = d.className.replace(/\s*jw(none|exactfit|uniform|fill)/g, ""), d.className += " " + q)
        }
    };
        ...
        d.onreadystatechange = function () {
            if (4 === d.readyState)if (200 === d.status) {
                ...
                for (f = 0; f < c.length; f++) {
                    var g = c[f], l = {};
                    try {
                        var j = g.indexOf('begin\x3d"'), g = g.substr(j + 7), j = g.indexOf('" end\x3d"');
                        l.begin = b(g.substr(0, j));
                        g = g.substr(j + 7);
                        j = g.indexOf('"\x3e');
                        l.end = b(g.substr(0, j));
                        g = g.substr(j + 2);
                        l.text = g
                    } catch (q) {
                    }
    ...
    (h.jwparser = function () {
        ...
        for (var a = [], b = [], c = f.utils.xmlAttribute, k = 0; k < e.childNodes.length; k++) {
            ...
            if ("jwplayer" == g.prefix) {
                var r = h.localName(g);
                "source" == r ? (delete d.sources, a.push({file: c(g, "file"), "default": c(g, "default"), label: c(g, "label"), type: c(g, "type")})) : "track" == r ? (delete d.tracks, b.push({file: c(g, "file"), "default": c(g, "default"), kind: c(g, "kind"), label: c(g, "label")})) : (d[r] = f.utils.serialize(h.textContent(g)), "file" ==
                    r && d.sources && delete d.sources)
            }
...
(function (f) {
    ...
    c.parseGroup = function (k, g) {
        var f, l, j = [];
        for (l = 0; l < b(k); l++)if (f = k.childNodes[l], "media" == f.prefix && d(f))switch (d(f).toLowerCase()) {
            case "content":
            ...
            case "subtitle":
                ...
                if (0 < e(f, "lang").length) {
                    var m = q;
                    f = e(f, "lang");
                    var p = {zh: "Chinese", nl: "Dutch", en: "English", fr: "French", de: "German", it: "Italian", ja: "Japanese", pt: "Portuguese", ru: "Russian", es: "Spanish"};
                    f = p[f] ? p[f] : f;
                    m.label = f
                }
                j.push(q)
        ...
        for (l =
                 0; l < j.length; l++)g.tracks.push(j[l]);
        return g
    }
})(jwplayer.html5.parsers);
(function (f) {
    function h(b) {
        for (var a = {}, h = 0; h < b.childNodes.length; h++) {
            var l = b.childNodes[h], j = c(l);
            if (j)switch (j.toLowerCase()) {
                case "enclosure":
                    a.file = e.xmlAttribute(l, "url");
                    break;
                case "title":
                    a.title = d(l);
                    break;
    ...
    f.rssparser.parse = function (e) {
        for (var g = [], d = 0; d < b(e); d++) {
            var f = a(e, d);
            if ("channel" == c(f).toLowerCase())for (var j = 0; j < b(f); j++) {
                var q = a(f, j);
...
(function (f) {
    f.srt = function (f, e, d) {
        ...
        function b(a) {
            ...
            for (a = 0; a < g.length; a++)if ("WEBVTT" != g[a]) {
                var c, p = g[a];
                c = {};
                var s = p.split("\r\n");
                ...
                try {
                    p = 1;
                    0 < s[0].indexOf(" --\x3e ") && (p = 0);
                    var v = s[p].indexOf(" --\x3e ");
                    0 < v && (c.begin =
                        r(s[p].substr(0, v)), c.end = r(s[p].substr(v + 5)));
                    if (s[p + 1]) {
                        c.text = s[p + 1];
                        for (p += 2; p < s.length; p++)c.text += "\x3cbr/\x3e" + s[p]
                    }
                } catch (u) {
                }
                c.text && (b.push(c), c.end && !d && (b.push({begin: c.end, text: ""}), delete c.end))
            }
            1 < b.length ? f(b) : e("Invalid SRT file: " + k)
        }

        var c, k, g = jwplayer.utils, r = g.seconds;
...
(function (f) {
    ...
    f.captions = function (a, g) {
        ...
        function l(a) {
            (I = a.fullscreen) ? (j(), setTimeout(j, 500)) : s(!0)
        }

        function j() {
            var a = n.offsetHeight, b = n.offsetWidth;
            0 != a && 0 != b && y.resize(b, Math.round(0.94 * a))
        }

        function q(a) {
            a = a.responseXML.firstChild;
            "xml" == f.parsers.localName(a) && (a = a.nextSibling);
            ("tt" == f.parsers.localName(a) ? new jwplayer.html5.parsers.dfxp(p, r) : new jwplayer.html5.parsers.srt(p,
                r)).load(E)
        }

        function m() {
            (new jwplayer.html5.parsers.srt(p, r)).load(E)
        }

        function p(a) {
            y.populate(a);
            D < x.length && (x[D].data = a);
            s(!1)
        }

        function s(a) {
            h.isMobile() || !x.length ? y.hide() : w == b && 0 < z ? (y.show(), I ? l({fullscreen: !0}) : (v(), a && setTimeout(v, 500))) : y.hide()
        }
        ...
        function u(a) {
            0 < a ? (D = a - 1, z = a) : z = 0;
            D >= x.length || (x[D].data ? y.populate(x[D].data) : (E = a = x[D].file, h.ajax(a, q, m)), s(!1))
        }

        function A() {
            var a = [];
            a.push({label: "Off"});
            for (var b = 0; b < x.length; b++)a.push({label: x[b].label});
            return a
        }

        var n, B = {back: !0, color: "#FFFFFF", fontSize: 15}, t = {fontFamily: "Arial,sans-serif", fontStyle: "normal", fontWeight: "normal", textDecoration: "none"}, y, w, D, x = [], z = 0, I = !1, E, C = new e.eventdispatcher;
        h.extend(this, C);
        ...
        this.setCurrentCaptions = function (a) {
            if (0 <= a && z != a && a <= x.length) {
                u(a);
                a = A();
                h.saveCookie("captionLabel", a[z].label);
                var b = e.JWPLAYER_CAPTIONS_CHANGED;
                C.sendEvent(b, {type: b, tracks: a,
                    track: z})
            }
        };
        n = c.createElement("div");
        n.id = a.id + "_caption";
        n.className = "jwcaptions";
        ...
        a.jwAddEventListener(e.JWPLAYER_PLAYLIST_ITEM, function () {
            ...
            x = [];
            y.update(0);
            for (var b = a.jwGetPlaylist()[a.jwGetPlaylistIndex()].tracks, g = [], c = 0, d = "", f = 0, d = "", c = 0; c < b.length; c++)d = b[c].kind.toLowerCase(), ("captions" == d || "subtitles" == d) && g.push(b[c]);
            for (c = z = 0; c < g.length; c++)if (d =
                g[c].file)g[c].label || (g[c].label = c.toString()), x.push(g[c]);
            for (c = 0; c < x.length; c++)if (x[c]["default"]) {
                f = c + 1;
                break
            }
            if (d = h.getCookies().captionLabel) {
                b = A();
                for (c = 0; c < b.length; c++)if (d == b[c].label) {
                    f = c;
                    break
                }
            }
            ...
            g = A();
            C.sendEvent(b, {type: b, tracks: g, track: z})
        });
        a.jwAddEventListener(e.JWPLAYER_MEDIA_ERROR, r);
        a.jwAddEventListener(e.JWPLAYER_ERROR, r);
        a.jwAddEventListener(e.JWPLAYER_READY, function () {
            h.foreach(B, function (a, b) {
                g && void 0 != g[a.toLowerCase()] ? "color" == a ? t.color =
                    "#" + String(g.color).substr(-6) : t[a] = g[a.toLowerCase()] : t[a] = b
            });
            y = new jwplayer.html5.captions.renderer(t, n);
            s(!1)
        });
        a.jwAddEventListener(e.JWPLAYER_MEDIA_TIME, function (a) {
            y.update(a.position)
        });
        a.jwAddEventListener(e.JWPLAYER_FULLSCREEN, l);
...
(function (f) {
    ...
    f.captions.renderer = function (e, d) {
        ...
        function b() {
            var a = r.clientWidth, b = Math.round(e.fontSize * Math.pow(a / 400, 0.6)), c = Math.round(1.4 * b);
            f(l, {maxWidth: a + "px", fontSize: b + "px", lineHeight: c + "px", visibility: m})
        }

        function c() {
            for (var b = -1, c = 0; c < g.length; c++)if (g[c].begin <= q && (c == g.length - 1 || g[c + 1].begin >= q)) {
                b = c;
                break
            }
            -1 == b ? a("") : b != j && (j = b, a(g[c].text))
        }
        ...
        r.appendChild(l);
        d.appendChild(r);
        f(r, {display: "block", height: "auto", position: "absolute", bottom: "20px", textAlign: "center", width: "100%"});
        f(l, {color: "#" + e.color.substr(-6), display: "inline-block", fontFamily: e.fontFamily, fontStyle: e.fontStyle,
            fontWeight: e.fontWeight, height: "auto", margin: "auto", position: "relative", textAlign: "center", textDecoration: e.textDecoration, wordWrap: "break-word", width: "auto"});
        e.back ? f(l, {background: "#000"}) : f(l, {textShadow: "-2px 0px 1px #000,2px 0px 1px #000,0px -2px 1px #000,0px 2px 1px #000,-1px 1px 1px #000,1px 1px 1px #000,1px -1px 1px #000,1px 1px 1px #000"});
        this.show = function () {
            f(r, {display: "block"});
            p || (p = setInterval(b, 250));
            b()
        };
...
(function (f) {
    ...
    f = e.transitionStyle;
    var c = "button", k = "text", g = "divider", r = "slider", l = "100%", j = {display: "none"}, q = {display: v}, m = !1, p = !0, s = null, v = void 0, u = window, A = document;
    h.controlbar = function (f, B) {
        function t(a, b, c) {
        ...
        function y(a) {
            var b = m, c;
            K.elapsed && (c = e.timeFormat(a.position), K.elapsed.innerHTML = c, b = c.length != e.timeFormat(wa).length);
        ...
        function I(a) {
            ba && (Ba = a.track, ma && 0 <= Ba && ma.setActive(a.track))
        }

        function E() {
            ca = e.extend({}, W, R.getComponentSettings("controlbar"), B);
            V = Q("background").height;
            b("#" + $, {height: V, bottom: ua ? 0 : ca.margin});
            b(C(".jwtext"), {font: ca.fontsize + "px/" + Q("background").height + "px " + ca.font, color: ca.fontcolor, "font-weight": ca.fontweight});
            b(C(".jwoverlay"), {bottom: V});
            0 < ca.maxwidth && b(C(), {"max-width": ua ? v : ca.maxwidth})
        }
        ...
        function F(a) {
            switch (a.type) {
                case g:
                    var e;
                    a.width ? (e = M(), e.className = "jwblankDivider", b(e, {width: parseInt(a.width)})) : a.element ? e = G(a.element) : (e = G(a.name), e || (e = M(), e.className = "jwblankDivider"));
                    a.className &&
                ...
                case k:
                    a = a.name;
                    e = {};
                    var d = Q(a + "Background");
                    if (d.src) {
                        var f = M();
                        f.id = $ + "_" + a;
                        f.className = "jwtext jw" + a;
                        e.background = "url(" + d.src + ") no-repeat center";
                        e["background-size"] = "100% " + Q("background").height + "px";
                        b(C(".jw" + a), e);
                        f.innerHTML = "00:00";
                        a = K[a] = f
                    } else a = null;
                    return a;
                case c:
                    if ("blank" != a.name)return a = a.name, Q(a + "Button").src ? (e = M(), e.className = "jw" + a + " jwbuttoncontainer", d = A.createElement("button"), d.addEventListener("click", T(a), m), d.innerHTML = "\x26nbsp;",
                        e.appendChild(d), d = Q(a + "Button"), f = Q(a + "ButtonOver"), N(C(".jw" + a + " button"), d, f), (d = bb[a]) && N(C(".jw" + a + ".jwtoggle button"), Q(d + "Button"), Q(d + "ButtonOver")), a = K[a] = e) : a = s, a;
                    break;
                case r:
                    d = a.name;
                    a = M();
                    var j = d + ("time" == d ? "Slider" : "") + "Cap", p = (f = "volume" == d) ? "Top" : "Left", q = f ? "Bottom" : "Right", I = G(j + p, s, m, m, f), t = G(j + q, s, m, m, f);
                    e = M();
                    var n = ["Rail", "Buffer", "Progress"], ea;
                    e.className = "jwrail jwsmooth";
                    for (var y = 0; y < n.length; y++) {
                        var L = "time" == d ? "Slider" : "", z = d + L + n[y], w = G(z, s, !f, "volume" == d), x = G(z + "Cap" +
                            p, s, m, m, f), B = G(z + "Cap" + q, s, m, m, f), u = Q(z + "Cap" + p), F = Q(z + "Cap" + q);
                        if (w) {
                            var E = M();
                            E.className = "jwrailgroup " + n[y];
                            x && E.appendChild(x);
                            E.appendChild(w);
                            B && (E.appendChild(B), B.className += " jwcap" + (f ? "Bottom" : "Right"));
                            b(C(".jwrailgroup." + n[y]), {"min-width": f ? v : u.width + F.width});
                            E.capSize = f ? u.height + F.height : u.width + F.width;
                            b(C("." + w.className), {left: f ? v : u.width, right: f ? v : F.width, top: f ? u.height : v, bottom: f ? F.height : v, height: f ? "auto" : v});
                            2 == y && (ea = E);
                            K[z] = E;
                            e.appendChild(E)
                        }
                    }
                    if (L = G(d + L + "Thumb", s, m, m, f))b(C("." +
                        L.className), {opacity: "time" == d ? 0 : 1, "margin-top": f ? L.skin.height / -2 : v}), L.className += " jwthumb", (f && ea ? ea : e).appendChild(L);
                    e.addEventListener("mousedown", Pa(d), m);
                    "time" == d && (e.addEventListener("mousemove", Ca, m), e.addEventListener("mouseout", S, m));
                    K[d + "Rail"] = e;
                    ea = Q(j + p);
                    j = Q(j + p);
                    Q(d + "SliderRail");
                    ...
                    b(C(".jw" + d + " .jwrail"), {left: f ? v : ea.width, right: f ? v : j.width, top: f ? ea.height : v, bottom: f ?
                        j.height : v, width: f ? l : v, height: f ? "auto" : v});
                    K[d] = a;
                    a.vertical = f;
                    "time" == d ? (na = new h.overlay($ + "_timetooltip", R), Ka = new h.thumbs($ + "_thumb"), Qa = A.createElement("div"), Qa.className = "jwoverlaytext", La = A.createElement("div"), d = Ka.element(), La.appendChild(d), La.appendChild(Qa), na.setContents(La), Va = e, J(0), d = na.element(), e.appendChild(d), K.timeSliderThumb && b(C(".jwtimeSliderThumb"), {"margin-left": Q("timeSliderThumb").width / -2}), Da(0), qa(0), qa(0), Da(0)) : "volume" == d && (b(C(".jwvolume"), {width: Q("volumeRail").width +
                        (f ? 0 : Q("volumeCap" + p).width + Q("volumeCap" + q).width), height: f ? Q("volumeCap" + p).height + Q("volumeRail").height + Q("volumeRailCap" + p).height + Q("volumeRailCap" + q).height + Q("volumeCap" + q).height : v}), f && (a.className += " jwvertical"));
                    return a
            }
        }

        function G(a, c, d, g, f) {
            var h = M();
            h.className = "jw" + a;
            var k = g ? " left center" : " center";
            g = Q(a);
            h.innerHTML = "\x26nbsp;";
            if (g && "" != g.src)return d = d ? {background: "url('" + g.src + "') repeat-x " + k, height: f ? g.height : v} : {background: "url('" + g.src + "') no-repeat" + k, width: g.width, height: f ?
                g.height : v}, h.skin = g, b(C(".jw" + a), e.extend(d, c)), K[a] = h
        }

        function N(a, c, e) {
            c.src && (b(a, {width: c.width, background: "url(" + c.src + ") center no-repeat"}), e.src && b(a + ":hover", {background: "url(" + e.src + ") center no-repeat"}))
        }
        ...
        function da() {
            ua || (Ma.show(), L("fullscreen"))
        }

        function Z(a, b) {
            e.exists(b) || (b = !Na[a]);
            K[a] && (K[a].className = "jw" + a +
                (b ? " jwtoggle jwtoggling" : " jwtoggling"), setTimeout(function () {
        ...
        function oa() {
            sa && 1 < sa.length && (Ra && (clearTimeout(Ra), Ra = void 0), la.show(), L("hd"))
        }

        function ea() {
            ba && 1 < ba.length && (Sa && (clearTimeout(Sa), Sa = void 0), ma.show(), L("cc"))
        }

        function Ta(a) {
            0 <= a && a < sa.length && (H.jwSetCurrentQuality(a), la.hide())
        }

        function Ua(a) {
            0 <= a && a < ba.length && (H.jwSetCurrentCaptions(a), ma.hide())
        }
        ...
        function Pa(b) {
            return function (c) {
                0 == c.button && (K[b + "Rail"].className = "jwrail", "time" == b ? H.jwGetState() != a.IDLE && (H.jwSeekDrag(p), ta = b) : ta = b)
            }
        }
        ...
        function fa(a) {
            ...
            if (50 < b - Xa) {
                if ((Oa = e.bounds(Va)) && 0 != Oa.width) {
                    ...
                    0 <= d && d <= Oa.width && (c.style.left = Math.round(d) + "px", J(ia * d / Oa.width), ka = e.bounds(O))
                }
                Xa = b
            }
            if (ta && 0 == a.button)return c = K[ta].getElementsByClassName("jwrail")[0], d = e.bounds(c), c = ta, d = K[c].vertical ? (d.bottom - a.pageY) / d.height :
                (a.pageX - d.left) / d.width, "mouseup" == a.type ? ("time" == c && H.jwSeekDrag(m), K[c + "Rail"].className = "jwrail jwsmooth", ta = s, Ya[c](d)) : ("time" == ta ? qa(d) : ja(d), 500 < b - Za && (Za = b, Ya[ta](d))), !1
        }

        function Ca() {
            na && (ia && !ua) && (pa(na), na.show())
        }
        ...
        function Ga(a) {
            ...
            xa[a] = b;
            if (ga[a] && (b = ga[a], a = xa[a], b && 0 < b.elements.length))for (var c = 0; c < b.elements.length; c++) {
                var d = F(b.elements[c]);
                d && ("volume" == b.elements[c].name && d.vertical ? (ra = new h.overlay($ + "_volumeOverlay", R), ra.setContents(d)) : a.appendChild(d))
            }
        }

        function za() {
            1 < H.jwGetPlaylist().length && (!A.querySelector("#" + H.id + " .jwplaylist") || H.jwGetFullscreen()) ?
                (b(C(".jwnext"), q), b(C(".jwprev"), q), b(C(".nextdiv"), q)) : (b(C(".jwnext"), j), b(C(".jwprev"), j), b(C(".nextdiv"), j))
        }
        ...
        function Y(a, b) {
            var c = K[a].vertical, d = a + ("time" == a ? "Slider" : ""), e = 100 * Math.min(Math.max(0,
                b), 1) + "%", g = K[d + "Progress"], d = K[d + "Thumb"], f = m;
            g && (c ? (g.style.height = e, g.style.bottom = 0, g.clientHeight <= g.capSize && (f = p)) : (g.style.width = e, g.clientWidth <= g.capSize && (f = p)), g.style.opacity = !f && 0 < b || ta ? 1 : 0);
        ...
        function Q(a) {
            return(a = R.getSkinElement(0 == a.indexOf("volume") ? "tooltip" : "controlbar", a)) ? a : {width: 0, height: 0, src: "", image: v, ready: m}
        }

        var H, R, U = t("divider", g), W = {margin: 8, maxwidth: 800, font: "Arial,sans-serif",
            ...
            mute: "unmute", fullscreen: "normalscreen"}, Na = {play: m, mute: m, fullscreen: m}, Wa = {play: function () {
            Na.play ? H.jwPause() : H.jwPlay()
        }, mute: function () {
            H.jwSetMute(!Na.mute);
            w({mute: Na.mute})
        }, fullscreen: function () {
        ...
        ha.redraw = function () {
            E();
            var a = Q("capLeft"), c = Q("capRight");
            b(C(".jwgroup.jwcenter"), {left: Math.round(e.parseDimension(xa.left.offsetWidth) + a.width), right: Math.round(e.parseDimension(xa.right.offsetWidth) + c.width)});
            a = !ua && O.parentNode.clientWidth > ca.maxwidth;
            c = ua ? 0 : ca.margin;
            b(C(), {left: a ? "50%" : c, right: a ? v : c, "margin-left": a ? O.clientWidth / -2 : v, width: a ? l : v});
            ka = e.bounds(O);
        ...
        ha.audioMode = function (a) {
            a != ua && (ua = a, b(C(".jwfullscreen"), {display: a ? "none" : v}), b(C(".jwhd"), {display: a ? "none" : v}),
                b(C(".jwcc"), {display: a ? "none" : v}), a && (b(C(".fsdiv"), j), b(C(".hddiv"), j)), ya())
        };
        ha.element = function () {
            return O
        };
        ha.margin = function () {
            return parseInt(ca.margin)
        };
        ha.height = function () {
            return V
        };
        ha.show = function () {
            ha.visible || (clearTimeout(Ha), Ha = v, ha.visible = !0, O.style.display = "inline-block", ya(), w(), Ha = setTimeout(function () {
                O.style.opacity = 1
            }, 10))
        };
        ha.hide = function () {
            ha.visible && (ha.visible = !1, O.style.opacity = 0, clearTimeout(Ha), Ha = v, Ha = setTimeout(function () {
        ...
        O = M();
        O.id = $;
        O.className = "jwcontrolbar";
        R = H.skin;
        ga = R.getComponentLayout("controlbar");
        ga || (ga = W.layout);
        e.clearCss("#" + $);
        E();
        var Ia = G("capLeft"), U = G("capRight"), ab = G("background", {position: "absolute", left: Q("capLeft").width, right: Q("capRight").width, "background-repeat": "repeat-x"}, p);
        ab && O.appendChild(ab);
        Ia && O.appendChild(Ia);
        Ga("left");
        Ga("center");
        Ga("right");
        O.appendChild(xa.left);
        O.appendChild(xa.center);
        O.appendChild(xa.right);
        K.hd && (la = new h.menu("hd", $ + "_hd",
            R, Ta), aa(la, K.hd, oa, va), Ea.hd = la);
        K.cc && (ma = new h.menu("cc", $ + "_cc", R, Ua), aa(ma, K.cc, ea, P), Ea.cc = ma);
        K.mute && (K.volume && K.volume.vertical) && (ra = new h.overlay($ + "_volumeoverlay", R), ra.setContents(K.volume), aa(ra, K.mute, X), Ea.volume = ra);
        K.fullscreen && (Ma = new h.overlay($ + "_fullscreenoverlay", R), Ia = A.createElement("div"), Ia.className = "jwoverlaytext", Ia.innerHTML = "Fullscreen", Ma.setContents(Ia), aa(Ma, K.fullscreen, da), Ea.fullscreen = Ma);
        b(C(".jwright"), {right: Q("capRight").width});
        U && O.appendChild(U);
        H.jwAddEventListener(d.JWPLAYER_MEDIA_TIME,
            y);
        H.jwAddEventListener(d.JWPLAYER_PLAYER_STATE, function (c) {
            switch (c.newstate) {
                case a.BUFFERING:
                case a.PLAYING:
                    b(C(".jwtimeSliderThumb"), {opacity: 1});
                    Z("play", p);
                    break;
                case a.PAUSED:
                    ta || Z("play", m);
                    break;
                case a.IDLE:
                    Z("play", m), b(C(".jwtimeSliderThumb"), {opacity: 0}), K.timeRail && (K.timeRail.className = "jwrail", setTimeout(function () {
                        K.timeRail.className += " jwsmooth"
                    }, 100)), Da(0), y({position: 0, duration: 0})
            }
        });
        H.jwAddEventListener(d.JWPLAYER_PLAYLIST_ITEM, function (a) {
            a = H.jwGetPlaylist()[a.index].tracks;
            if ("array" == e.typeOf(a))for (var b = 0; b < a.length; b++)if (a[b].file && a[b].kind && "thumbnails" == a[b].kind.toLowerCase()) {
                Ka.load(a[b].file);
                return
            }
            Ka.load()
        });
        H.jwAddEventListener(d.JWPLAYER_MEDIA_MUTE, w);
        H.jwAddEventListener(d.JWPLAYER_MEDIA_VOLUME, D);
        H.jwAddEventListener(d.JWPLAYER_MEDIA_BUFFER, function (a) {
            Da(a.bufferPercent / 100)
        });
        H.jwAddEventListener(d.JWPLAYER_FULLSCREEN, function (a) {
            Z("fullscreen", a.fullscreen);
            za()
        });
        H.jwAddEventListener(d.JWPLAYER_PLAYLIST_LOADED, x);
        H.jwAddEventListener(d.JWPLAYER_MEDIA_LEVELS,
            function (a) {
                if ((sa = a.levels) && 1 < sa.length && la) {
                    b(C(".jwhd"), {display: v});
                    la.clearOptions();
                    for (var c = 0; c < sa.length; c++)la.addOption(sa[c].label, c);
                    z(a)
                } else b(C(".hddiv"), j), b(C(".jwhd"), {display: "none"});
                ya()
            });
        H.jwAddEventListener(d.JWPLAYER_MEDIA_LEVEL_CHANGED, z);
        H.jwAddEventListener(d.JWPLAYER_CAPTIONS_LIST, function (a) {
            if ((ba = a.tracks) && 1 < ba.length && ma) {
                b(C(".jwcc"), {display: v});
                ma.clearOptions();
                for (var c = 0; c < ba.length; c++)ma.addOption(ba[c].label, c);
                I(a)
            } else b(C(".jwcc"), {display: "none"});
            ya()
        });
        H.jwAddEventListener(d.JWPLAYER_CAPTIONS_CHANGED, I);
        O.addEventListener("mouseover", function () {
            u.addEventListener("mousemove", fa, m);
            u.addEventListener("mouseup", fa, m);
            u.addEventListener("mousedown", Fa, m)
        }, !1);
    ...
    b(".jwcontrolbar buttoncontainer,.jwcontrolbar button", {display: "inline-block", height: l, border: "none", cursor: "pointer"});
    ...
    b(".jwcontrolbar .jwtime", {position: "absolute", height: l, width: l, left: 0});
    b(".jwcontrolbar .jwthumb", {position: "absolute", height: l, cursor: "pointer"});
    b(".jwcontrolbar .jwrail", {position: "absolute", cursor: "pointer"});
    b(".jwcontrolbar .jwrailgroup", {position: "absolute", width: l});
...
(function (f) {
    ...
    h.controller = function (b, c) {
        ...
        function r(b) {
            ...
            try {
                0 <= t && (g(t), t = -1);
                if (!y && (y = !0, n.sendEvent(d.JWPLAYER_MEDIA_BEFOREPLAY), y = !1, x)) {
                    x = !1;
                    w = null;
                    return
                }
                ...
                n.sendEvent(d.JWPLAYER_ERROR, c), w = null
            }
            return!1
        }
        ...
        function l(b) {
            w = null;
            try {
                return u.state != a.IDLE ? A.stop() : b || (D = !0), y && (x = !0), !0
            } catch (c) {
                n.sendEvent(d.JWPLAYER_ERROR, c)
            }
            return!1
        }
        ...
        function p() {
            u.state == a.IDLE && (D ? D = !1 : (w = p, u.repeat ? m() : u.item == u.playlist.length - 1 ? (t = 0, l(!0), setTimeout(function () {
                n.sendEvent(d.JWPLAYER_PLAYLIST_COMPLETE)
            }, 0)) : m()))
        }

        function s(a) {
            return function () {
                B ? v(a, arguments) : z.push({method: a, arguments: arguments})
            }
        }
        ...
        var u = b, A = b.getVideo(), n = new d.eventdispatcher(u.id,
            u.config.debug), B = !1, t = -1, y, w, D = !1, x, z = [];
        e.extend(this, n);
        this.play = s(r);
        this.pause = s(j);
        this.seek = s(function (b) {
            u.state != a.PLAYING && r(!0);
            A.seek(b)
        });
        this.stop = function () {
            D = !0;
        ...
        this.attachMedia = function (a) {
            try {
                u.getVideo().attachMedia(a), "function" == typeof w && w()
            } catch (b) {
                return null
            }
        };
        ...
        this.playerReady = function (a) {
            if (!B) {
                ...
                n.sendEvent(f.events.JWPLAYER_PLAYLIST_LOADED, {playlist: f(u.id).getPlaylist()});
                n.sendEvent(f.events.JWPLAYER_PLAYLIST_ITEM, {index: u.item});
                g();
                u.autostart && !e.isMobile() && r();
                for (B = !0; 0 < z.length;)a = z.shift(), v(a.method, a.arguments)
            }
        };
...
(function (f) {
    ...
    f.display = function (r, l) {
        ...
        function q(a, b) {
            L.showicons && (a || b ? (G.setRotation("buffer" == a ? parseInt(L.bufferrotation) : 0, parseInt(L.bufferinterval)), G.setIcon(a), G.setText(b)) : G.hide())
        }

        function m(b) {
            D != b ? (D && n(c, g), (D = b) ? (b = new Image, b.addEventListener("load",
                v, g), b.src = D) : (a("#" + t.id + " " + c, {"background-image": void 0}), n(c, g), x = z = 0)) : D && n(c, k);
            s(B.jwGetState())
        }
        ...
        function s(a) {
            a = N ? N : B ? B.jwGetState() : d.IDLE;
            if (a != T)switch (T = a, G && G.setRotation(0), a) {
                case d.IDLE:
                    !C && !M && (D && !I && n(c, k), a = !0, B._model && !1 === B._model.config.displaytitle && (a = !1), q("play", w && a ? w.title : ""));
                    break;
                case d.BUFFERING:
                    C = g;
                    E.error && E.error.setText();
                    M = g;
                    q("buffer");
                    break;
                case d.PLAYING:
        ...
        function v() {
            ...
            s(B.jwGetState());
            A();
            D && a("#" + t.id + " " + c, {"background-image": "url(" + D + ")"})
        }
        ...
        function A() {
            0 < t.clientWidth * t.clientHeight && h.stretch(B.jwGetStretching(), y, t.clientWidth, t.clientHeight, x, z)
        }
        ...
        var B = r, t, y, w, D, x, z, I = g, E = {}, C = g, M = g, F = {}, G, N, T, L = h.extend({showicons: k, bufferrotation: 45, bufferinterval: 100,
            fontcolor: "#ccc", overcolor: "#fff", fontsize: 15, fontweight: ""}, r.skin.getComponentSettings("display"), l), X = new e.eventdispatcher, da;
        h.extend(this, X);
        this.clickHandler = j;
        var Z;
        ...
        this.redraw = A;
        this.show = function () {
            G && (N ? N : B ? B.jwGetState() : d.IDLE) != d.PLAYING && G.show()
        };
        this.hide = function () {
            G && G.hide()
        };
        ...
        y.className = "jwpreview jw" + B.jwGetStretching();
        t.appendChild(y);
        B.jwAddEventListener(e.JWPLAYER_PLAYER_STATE, p);
        B.jwAddEventListener(e.JWPLAYER_PLAYLIST_ITEM, function () {
            C = g;
            E.error && E.error.setText();
            var a = (w = B.jwGetPlaylist()[B.jwGetPlaylistIndex()]) ? w.image : "";
            T = void 0;
            m(a)
        });
        B.jwAddEventListener(e.JWPLAYER_PLAYLIST_COMPLETE, function () {
            M =
                k;
            q("replay");
            var a = B.jwGetPlaylist()[0];
            m(a.image)
        });
        B.jwAddEventListener(e.JWPLAYER_MEDIA_ERROR, u);
        B.jwAddEventListener(e.JWPLAYER_ERROR, u);
        t.addEventListener("click", j, g);
        var oa = {font: L.fontweight + " " + L.fontsize + "px/" + (parseInt(L.fontsize) + 3) + "px Arial,Helvetica,sans-serif", color: L.fontcolor};
        G = new f.displayicon(t.id + "_button", B, oa, {color: L.overcolor});
...
(function (f) {
    ...
    f.displayicon = function (f, g, r, l) {
        function j(a, b) {
            return"#" + B + (b ? ":hover" : "") + " " + (a ? a : "")
        }
        ...
        function m(a, b, c, d) {
            var g = p(a);
            "replayIcon" == a && !g.src && (g = p("playIcon"));
            c = h.extend({}, c);
            ...
            I = g;
            e("#" + A.id + " .jwdisplay:hover " + (b ? b : j()), d)
        }

        function p(a) {
            var b = n.getSkinElement("display", a);
            a = n.getSkinElement("display", a + "Over");
            return b ? (b.overSrc = a && a.src ? a.src : "", b) : {src: "", overSrc: "", width: 0, height: 0}
        }

        function s() {
            var a = D || 0 == E, g = "px " + c;
            e(j(".jwtext"), {display: x.innerHTML && a ? d : b});
            M = 10;
            setTimeout(function () {
                v(g)
            }, 0);
        ...
        function v(a) {
            if (0 >= M)clearInterval(C); else {
                M--;
                var b = Math.max(I.width, h.bounds(t).width -
                    w.width - y.width);
                (h.isFF() || h.isIE()) && b++;
                h.isChrome() && 1 == t.parentNode.clientWidth % 2 && b++;
                e(j(), {"background-size": [y.width + a, b + a, w.width + a].join()}, !0)
            }
        }
        ...
        var A = g, n = A.skin, B = f, t, y, w, D, x, z, I, E = 0, C, M;
        this.element = function () {
            return t
        };
        this.setText = function (b) {
            ...
            c.height = "0";
            c.display = "block";
            if (b)for (; 2 < Math.floor(x.scrollHeight / a.defaultView.getComputedStyle(x, null).lineHeight.replace("px", ""));)x.innerHTML =
                x.innerHTML.replace(/(.*) .*$/, "$1...");
            c.height = "";
            c.display = "";
            s()
        };
        this.setIcon = function (a) {
            ...
            b.id = t.id + "_" + a;
            m(a + "Icon", "#" + b.id);
            t.contains(z) ? t.replaceChild(b, z) : t.appendChild(b);
            z = b
        };
        var F, G = 0, N;
        ...
        w = p("capRight");
        D = 0 < y.width * w.width;
        var T = {"background-image": "url(" +
            y.src + "), url(" + f.src + "), url(" + w.src + ")", "background-position": "left,center,right", "background-repeat": "no-repeat", padding: "0 " + w.width + "px 0 " + y.width + "px", height: f.height, "margin-top": f.height / -2};
        e(j(), T);
        f.overSrc && (T["background-image"] = "url(" + y.overSrc + "), url(" + f.overSrc + "), url(" + w.overSrc + ")");
        e("#" + A.id + " .jwdisplay:hover " + j(), T);
        x = q("jwtext", t, r, l);
        z = q("jwicon", t);
        g();
        s()
    };
    e(".jwdisplayIcon", {display: "table", cursor: "pointer", position: "relative", "margin-left": "auto", "margin-right": "auto",
        top: "50%"}, !0);
...
(function (f) {
    ...
    f.dock = function (g, r) {
        function l(a, b) {
            var c = m(a);
            e(j("." + a), {width: c.width, background: c.src});
            return q("div", a, b)
        }
        ...
        var s = h.extend({},
            {iconalpha: 0.75, iconalphaactive: 0.5, iconalphaover: 1, margin: 8}, r), v = g.id + "_dock", u = g.skin, A = 0, n = {}, B = {}, t, y, w = this;
        w.redraw = function () {
            d(t)
        };
        w.element = function () {
        ...
        w.hide = function () {
            w.visible && (w.visible = !1, t.style.opacity = 0, setTimeout(function () {
                t.style.display = c
            }, 150))
        };
        w.show = function () {
            !w.visible && A && (w.visible = !0, t.style.display = k, setTimeout(function () {
                t.style.opacity = 1
            }, 0))
        };
        w.addButton = function (a, b, c, g) {
            if (!n[g]) {
                var k = q("div", "divider",
                    y), j = q("button", null, y), l = q("div", null, j);
                l.id = v + "_" + g;
                l.innerHTML = "\x26nbsp;";
                ...
                n[g] = {element: j, label: b, divider: k, icon: l};
                if (b) {
                    var m = new f.overlay(l.id + "_tooltip", u, !0);
                    a = q("div");
                    a.id = l.id + "_label";
                    a.innerHTML = b;
                    e("#" + a.id, {padding: 3});
                    ...
                    j.addEventListener("mouseout", function () {
                        s = setTimeout(m.hide, 100)
                    }, !1);
                    t.appendChild(m.element());
                    B[g] = m
                }
                A++;
                p()
        ...
        w.removeButton = function (a) {
            n[a] && (y.removeChild(n[a].element), y.removeChild(n[a].divider), delete n[a], A--, p())
        };
        ...
        w.visible = !1;
        t = q("div", "jwdock");
        y = q("div", "jwdockbuttons");
        t.appendChild(y);
        t.id = v;
        var D = m("button"), x = m("buttonOver"), z = m("buttonActive");
        D && (e(j(), {height: D.height, padding: s.margin}), e(a, {height: D.height}), e(j("button"), {width: D.width, cursor: "pointer", border: c, background: D.src}), x.src && e(j("button:hover"), {background: x.src}), z.src && e(j("button:active"), {background: z.src}), e(j("button\x3ediv"), {opacity: s.iconalpha}), e(j("button:hover\x3ediv"), {opacity: s.iconalphaover}), e(j("button:active\x3ediv"), {opacity: s.iconalphaactive}), e(j(".jwoverlay"), {top: s.margin + D.height}), l("capLeft",
            y), l("capRight", y), l("divider"));
        setTimeout(function () {
            d(t)
        })
    };
    e(".jwdock", {opacity: 0, display: c});
    e(".jwdock \x3e *", {height: "100%", "float": "left"});
    e(".jwdock \x3e .jwoverlay", {height: "auto", "float": c, "z-index": 99});
    e(a + " button", {position: "relative"});
    e(a + " \x3e *", {height: "100%", "float": "left"});
    e(a + " .divider", {display: c});
    e(a + " button ~ .divider", {display: k});
    e(a + " .capLeft, " + a + " .capRight", {display: c});
    e(a + " .capRight", {"float": "right"});
    e(a + " button \x3e div", {left: 0, right: 0, top: 0, bottom: 0,
        margin: 5, position: "absolute", "background-position": "center", "background-repeat": "no-repeat"});
...
(function (f) {
    ...
    f.instream = function (c, h, g, r) {
        function l(a) {
            a.type == d.JWPLAYER_MEDIA_ERROR && (a = e.extend({}, a), a.type = d.JWPLAYER_ERROR);
            s(a.type, a);
            N = !0;
            G.jwInstreamDestroy(!1)
        }
        ...
        function m() {
            E && setTimeout(function () {
                G.jwInstreamDestroy(!0)
            }, 10)
        }

        function p(a) {
            a.width && a.height && B.resizeMedia()
        }
        ...
        var u = {controlbarseekable: "never",
            controlbarpausable: !0, controlbarstoppable: !0, playlistclickable: !0}, A, n, B = g, t, y, w, D, x, z, I, E = !1, C, M, F, G = this, N = !1, T = !0;
        this.load = function (g, C) {
            e.isAndroid(2.3) ? l({type: d.JWPLAYER_ERROR, message: "Error loading instream: Cannot play instream on Android 2.3"}) : (E = !0, n = e.extend(u, C), A = new b.item(g), M = document.createElement("div"), M.id = G.id + "_instream_container", t = r.detachMedia(), x = new f.video(t), x.addGlobalListener(j), x.addEventListener(d.JWPLAYER_MEDIA_META, p), x.addEventListener(d.JWPLAYER_MEDIA_COMPLETE,
                ...
                F.state ==
                    a.PAUSED ? G.jwInstreamPlay() : (G.jwInstreamPause(), s(d.JWPLAYER_INSTREAM_CLICK, b))
            }), M.appendChild(I.element()), e.isMobile() || (z = new f.controlbar(G), M.appendChild(z.element()), z.show()), B.setupInstream(M, z, I, t), v(), x.load(F.playlist[0])))
        };
        this.jwInstreamDestroy = function (b) {
            if (E) {
                E = !1;
                w != a.IDLE ? x.load(D, !1) : x.stop();
                C.resetEventListeners();
                N || I.revertAlternateClickHandler();
                x.detachMedia();
                B.destroyInstream();
                if (z)try {
                    z.element().parentNode.removeChild(z.getDisplayElement())
                } catch (c) {
                }
                s(d.JWPLAYER_INSTREAM_DESTROYED,
                    {reason: b ? "complete" : "destroyed"}, !0);
                r.attachMedia();
                if (w == a.BUFFERING || w == a.PLAYING)t.play(), h.playlist[h.item] == D && T && h.getVideo().seek(y)
            }
        };
        ...
        this.jwInstreamPlay = function () {
            E && (x.play(!0), h.state = jwplayer.events.state.PLAYING, I.show())
        };
        this.jwInstreamPause = function () {
            E && (x.pause(!0), h.state = jwplayer.events.state.PAUSED, I.show())
        };
        this.jwInstreamSeek =
            function (a) {
                E && x.seek(a)
        ...
        this.jwPlay = function () {
            "true" == n.controlbarpausable.toString().toLowerCase() && this.jwInstreamPlay()
        };
        this.jwPause = function () {
            "true" == n.controlbarpausable.toString().toLowerCase() && this.jwInstreamPause()
        };
        this.jwStop = function () {
            "true" == n.controlbarstoppable.toString().toLowerCase() && (this.jwInstreamDestroy(), c.jwStop())
        };
        this.jwSeek = function (a) {
            switch (n.controlbarseekable.toLowerCase()) {
                case "always":
                    this.jwInstreamSeek(a);
                    break;
                case "backwards":
                    F.position > a && this.jwInstreamSeek(a)
            }
        };
        ...
        c.jwAddEventListener(d.JWPLAYER_RESIZE, v);
...
(function (f) {
    var h = f.utils, e = h.css, d = f.events.state, a = f.html5.logo = function (b, c) {
        function k(a) {
            ...
            if (!m || !l.link)g.jwGetState() == d.IDLE || g.jwGetState() == d.PAUSED ? g.jwPlay() : g.jwPause();
            m && l.link && (g.jwPause(), g.jwSetFullscreen(!1), window.open(l.link, l.linktarget))
        }

        var g = b, r = g.id + "_logo", l, j, q = a.defaults, m = !1;
        this.resize = function () {
        };
        this.element = function () {
            return j
        ...
        this.hide = function (a) {
            if (l.hide || a)m = !1, j.style.visibility = "hidden", j.style.opacity = 0
        };
        this.show = function () {
            m = !0;
        ...
        var p = "o";
        g.edition && (p = g.edition(), p = "pro" == p ? "p" : "premium" == p ? "r" : "ads" == p ? "a" : "free" == p ? "f" : "o");
        if ("o" == p || "f" == p)q.link = "http://www.longtailvideo.com/jwpabout/?a\x3dl\x26v\x3d" + f.version + "\x26m\x3dh\x26e\x3d" + p;
        l = h.extend({}, q, c);
        ...
        j.id = r;
        if (l.file) {
            var q = /(\w+)-(\w+)/.exec(l.position), p = {}, s = l.margin;
            3 == q.length ? (p[q[1]] = s, p[q[2]] = s) : p.top = p.right = s;
            e("#" + r + " ", p);
...
(function (f) {
    ...
    h.menu = function (b, c, f, g) {
        ...
        var q = g, m = new h.overlay(c + "_overlay", f);
        ...
        this.addOption = function (a, b) {
            ...
            d.id = c + "_option_" + b;
            d.innerHTML = a;
            d.addEventListener("click", r(s.length, b));
            s.push(d)
        };
        this.clearOptions = function () {
            for (; 0 < s.length;)p.removeChild(s.pop())
        };
        ...
        var u = j("menuTop" +
            b);
        b = j("menuOption");
        var A = j("menuOptionOver"), n = j("menuOptionActive");
        u && u.image && p.appendChild(u.image);
        b && (u = "#" + c + " .jwoption", d(u, {"background-image": b.src, height: b.height, color: g.fontcolor, "padding-left": b.width, font: g.fontweight + " " + g.fontsize + "px Arial,Helvetica,sans-serif", "line-height": b.height, "text-transform": "upper" == g.fontcase ? "uppercase" : a}), d(u + ":hover", {"background-image": A.src ? A.src : a, color: g.overcolor}), d(u + ".active", {"background-image": n.src ? n.src : a, color: g.activecolor}));
        m.setContents(p)
    };
...
(function (f) {
    ...
    f.model = function (d, a) {
        function b(a) {
            var b = j[a.type] ? j[a.type].split(",") : [], d, g;
            if (0 < b.length) {
                for (d = 0; d < b.length; d++) {
                    var e = b[d].split("-\x3e"), f = e[0], e = e[1] ? e[1] : f;
                    c[e] != a[f] && (c[e] = a[f], g = !0)
                }
        ...
        var c = this, k, g;
        g = h.getCookies();
        var r = {controlbar: {}, display: {}}, l = {autostart: !1, controls: !0, debug: void 0, fullscreen: !1, height: 320, mobilecontrols: !1, mute: !1, playlist: [], playlistposition: "none", playlistsize: 180,
            repeat: !1, skin: void 0, stretching: h.stretching.UNIFORM, width: 480, volume: 90}, j = {};
        j[e.JWPLAYER_MEDIA_MUTE] = "mute";
        j[e.JWPLAYER_MEDIA_VOLUME] = "volume";
        j[e.JWPLAYER_PLAYER_STATE] = "newstate-\x3estate";
        j[e.JWPLAYER_MEDIA_BUFFER] = "bufferPercent-\x3ebuffer";
        j[e.JWPLAYER_MEDIA_TIME] = "position,duration";
        c.getVideo = function () {
            return k
        };
        ...
        c.setItem = function (a) {
            ...
            if (b || a != c.item)c.item = a, c.sendEvent(e.JWPLAYER_PLAYLIST_ITEM, {index: c.item})
        };
...
(function (f) {
    var h = f.utils, e = h.css, d = h.transitionStyle, a = "top", b = "bottom", c = "right", k = "left", g = void 0, r = document, l = {fontcase: g, fontcolor: "#ffffff", fontsize: 12, fontweight: g, activecolor: "#ffffff", overcolor: "#ffffff"};
    f.html5.overlay = function (d, f, m) {
        function p(a) {
            return"#" + B + (a ? " ." + a : "")
        }
        ...
        function v(a, b) {
            var c;
            c = (c = n.getSkinElement("tooltip", a)) ? c : {width: 0, height: 0, src: "", image: g, ready: !1};
            var d = s(b, t);
            e(p(b.replace(" ",
        ...
        function u(d, f) {
            f || (f = "");
            var h = v("cap" + d + f, "jwborder jw" + d + (f ? f : "")), l = h[0], h = h[1], j = {"background-image": h.src, width: d == k || f == k || d == c || f == c ? h.width : g, height: d == a || f == a || d == b || f == b ? h.height : g};
            j[d] = d == b && !z || d == a && z ? x : 0;
            f && (j[f] = 0);
            e(p(l.className.replace(/ /g, ".")), j);
            l = {};
            j = {};
            h = {left: h.width, right: h.width, top: (z ? x : 0) + h.height, bottom: (z ? 0 : x) + h.height};
            f && (l[f] = h[f], l[d] = 0, j[d] = h[d], j[f] = 0, e(p("jw" + d), l), e(p("jw" + f), j), I[d] = h[d], I[f] = h[f])
        }

        function A() {
            0 !=
                t.clientWidth && (e(p(), {"margin-left": Math.round(w - t.clientWidth / 2)}), e(p("jwarrow"), {"margin-left": Math.round(D.width / -2 - w)}))
        }

        var n = f, B = d, t, y, w = 0, D, x, z = m;
        d = h.extend({}, l, n.getComponentSettings("tooltip"));
        var I = {}, E = this;
        E.element = function () {
            return t
        };
        var C;
        E.setContents = function (a) {
            h.empty(y);
            y.appendChild(a);
            clearTimeout(C);
            C = setTimeout(A, 0)
        };
        E.offsetX = function (a) {
            w = a;
            clearTimeout(C);
            A()
        };
        E.borderWidth = function () {
            return I.left
        };
        E.show = function () {
            E.showing = !0;
        ...
        D = v("arrow", "jwarrow")[1];
        x = D.height;
        e(p("jwarrow"), {position: "absolute", bottom: z ? g : 0, top: z ? 0 : g, width: D.width, height: x, left: "50%"});
        u(a, k);
        u(b, k);
        u(a, c);
        u(b, c);
        ...
        u(b);
        v("background", "jwback");
        e(p("jwback"), {left: I.left, right: I.right, top: I.top, bottom: I.bottom});
        y = s("jwcontents", t);
        e(p("jwcontents") + " *", {color: d.fontcolor, font: d.fontweight + " " + d.fontsize + "px Arial,Helvetica,sans-serif",
            "text-transform": "upper" == d.fontcase ? "uppercase" : g});
        z && h.transform(p("jwarrow"), "rotate(180deg)");
        e(p(), {padding: I.top + 1 + "px " + I.right + "px " + (I.bottom + 1) + "px " + I.left + "px"});
        E.showing = !1
    };
    ...
    f.player = function (e) {
        function d(a) {
            ...
            0 < a.tracks.length && h.foreach(a.tracks, function (a, c) {
                b.tracks.push({file: c.file, kind: c.kind ? c.kind : void 0, label: c.label, "default": c["default"] ?
                    !0 : !1})
            });
        ...
        b.jwGetPlaylist = function () {
            for (var a = c.playlist, b = [], g = 0; g < a.length; g++)b.push(d(a[g]));
            return b
        };
...
(function (f) {
    ...
    f.playlistcomponent = function (c, k) {
        ...
        var j = c, q = j.skin, m = d.extend({}, h, j.skin.getComponentSettings("playlist"), k), p, s, v, u, A = -1, n, B, t = -1, y = 60, w = {background: void 0, divider: void 0, item: void 0, itemOver: void 0, itemImage: void 0, itemActive: void 0}, D = this;
        D.element = function () {
            return p
        };
        D.redraw = function () {
        ...
        p = r("div", "jwplaylist");
        p.id = j.id + "_jwplayer_playlistcomponent";
        s = r("div", "jwlistcontainer");
        p.appendChild(s);
        d.foreach(w, function (a) {
            w[a] = q.getSkinElement("playlist",
                a)
        });
        w.item && (y = w.item.height);
        var x = 0, z = 0, I = 0;
        d.clearCss(g());
        a(g(), {"background-color": m.backgroundcolor});
        a(g("jwlist"), {"background-image": w.background ? " url(" + w.background.src + ")" : ""});
        a(g("jwlist *"), {color: m.fontcolor, font: m.fontweight + " " + m.fontsize + "px Arial, Helvetica, sans-serif"});
        w.itemImage ? (x = (y - w.itemImage.height) / 2 + "px ", z = w.itemImage.width, I = w.itemImage.height) : (z = 4 * y / 3, I = y);
        w.divider && a(g("jwplaylistdivider"), {"background-image": "url(" + w.divider.src + ")", "background-size": "100% " +
            w.divider.height + "px", width: "100%", height: w.divider.height});
        a(g("jwplaylistimg"), {height: I, width: z, margin: x ? x + x + x + x : "0 5px 0 0"});
        a(g("jwlist li"), {"background-image": w.item ? "url(" + w.item.src + ")" : "", height: y, "background-size": "100% " + y + "px", cursor: "pointer"});
        z = {overflow: "hidden"};
        "" !== m.activecolor && (z.color = m.activecolor);
        w.itemActive && (z["background-image"] = "url(" + w.itemActive.src + ")");
        a(g("jwlist li.active"), z);
        a(g("jwlist li.active .jwtitle"), {color: m.titleactivecolor});
        z = {overflow: "hidden"};
        "" !== m.overcolor && (z.color = m.overcolor);
        w.itemOver && (z["background-image"] = "url(" + w.itemOver.src + ")");
        a(g("jwlist li:hover"), z);
        a(g("jwlist li:hover .jwtitle"), {color: m.titleovercolor});
        a(g("jwtextwrapper"), {height: y - 5, position: "relative"});
        a(g("jwtitle"), {height: 15, overflow: "hidden", display: "inline-block", width: "100%", color: m.titlecolor, "margin-top": x ? x : 7, "line-height": 13, "font-size": m.titlesize, "font-weight": m.titleweight});
        a(g("jwdescription"), {display: "block", "font-size": m.fontsize, "line-height": 19,
            "margin-top": 5, overflow: "hidden", height: y, position: "relative"});
        j.jwAddEventListener(e.JWPLAYER_PLAYLIST_LOADED, function () {
            s.innerHTML = "";
            for (var b = j.jwGetPlaylist(), c = [], g = 0; g < b.length; g++)b[g]["ova.hidden"] || c.push(b[g]);
            if (v = c) {
                b = r("ul", "jwlist");
                b.id = p.id + "_ul" + Math.round(1E7 * Math.random());
                u = b;
                for (b = 0; b < v.length; b++) {
                    var e = b, c = v[e], g = r("li", "jwitem"), h = void 0;
                    g.id = u.id + "_item_" + e;
                    0 < e && (h = r("div", "jwplaylistdivider"), g.appendChild(h));
                    e = r("div", "jwplaylistimg jwfill");
                    if (c.image || c["playlist.image"] ||
                        w.itemImage)h = void 0, c["playlist.image"] ? h = c["playlist.image"] : c.image ? h = c.image : w.itemImage && (h = w.itemImage.src), a("#" + g.id + " .jwplaylistimg", {"background-image": h ? "url(" + h + ")" : null}), g.appendChild(e);
                    e = r("div", "jwtextwrapper");
                    h = r("span", "jwtitle");
                    h.innerHTML = c && c.title ? c.title : "";
                    e.appendChild(h);
                    c.description && (h = r("span", "jwdescription"), h.innerHTML = c.description, e.appendChild(h));
                    g.appendChild(e);
                    c = g;
                    c.onclick = l(b);
                    u.appendChild(c)
                ...
                d.isIOS() && window.iScroll ? (p.innerHTML =
                    "", p.appendChild(u), u.style.height = y * v.length + "px", new iScroll(p.id)) : (s.appendChild(u), B = new f.playlistslider(p.id + "_slider", j.skin, p, u))
            }
        });
        j.jwAddEventListener(e.JWPLAYER_PLAYLIST_ITEM, function (a) {
            ...
            a = j.jwGetPlaylistIndex();
            a != n && (n = -1, d.isIOS() && window.iScroll ? u.scrollTop = a * y : B && B.visible() && B.thumbPosition(a / (j.jwGetPlaylist().length - 1)))
        });
        var E = setInterval(function () {
            var a =
                b.getElementById(p.id), c = d.bounds(a).height;
            a != p ? clearInterval(E) : c != t && (t = c, D.redraw())
        }, 200);
        return this
    };
    ...
    a(".jwplaylist .jwlist", {position: "absolute", width: "100%", "list-style": "none", margin: 0, padding: 0, overflow: "hidden"});
    a(".jwplaylist .jwlistcontainer", {position: "absolute",
    ...
    f.playlistloader = function () {
        function a(a) {
            try {
                ...
                a = "";
                for (var l = 0; l < b.length && !(a = b[l], a.nodeType != a.COMMENT_NODE); l++);
                "xml" == f.parsers.localName(a) && (a = a.nextSibling);
                if ("rss" != f.parsers.localName(a))c("Not a valid RSS feed"); else {
                    var j = new h.playlist(f.parsers.rssparser.parse(a));
                    if (b = j) {
                        a = [];
                        var q, m, p;
                        for (q = 0; q < b.length; q++)if (m = b[q], (p = e.filterSources(m.sources)) && p.length)m.sources = p, a.push(m);
                        j = a
                    } else j = void 0;
                    j &&
                        j.length && j[0].sources && j[0].sources.length && j[0].sources[0].file ? k.sendEvent(d.JWPLAYER_PLAYLIST_LOADED, {playlist: j}) : c("No playable sources found")
                }
            } catch (s) {
                c()
            }
...
(function (f) {
    ...
    f.playlistslider = function (f, g, h, l) {
        function j(a) {
            return"#" + n.id + (a ? " ." + a : "")
        }
        ...
        function q(b, e, g, f) {
            ...
            b && (h.className = b, e && d(j(b), {"background-image": e.src ? e.src : c, "background-repeat": f ? "repeat-y" : "no-repeat", height: f ? c : e.height}));
            g && g.appendChild(h);
            return h
        }
        ...
        function m(a) {
            return(a = A.getSkinElement("playlist",
                a)) ? a : {width: 0, height: 0, src: c}
        }

        function p(a) {
            if (z)return a = a ? a : b.event, X(w - (a.detail ? -1 * a.detail : a.wheelDelta / 40) / 10), a.stopPropagation && a.stopPropagation(), a.preventDefault && a.preventDefault(), a.cancelBubble = !0, a.cancel = !0, a.returnValue = !1
        }

        function s(a) {
            if (y || "click" == a.type) {
                var b = e.bounds(B), c = t.clientHeight / 2;
        ...
        function v(a) {
            return function (b) {
                0 < b.button || (X(w + 0.05 * a), D = setTimeout(function () {
        ...
        var A = g, n, B, t, y, w = 0, D, x, z = !0, I, E, C, M, F, G, N, T;
        this.element = function () {
            return n
        };
        ...
        var L = this.redraw = function () {
            ...
            T = setTimeout(function () {
                if (l && l.clientHeight) {
                    ...
                    0 > a && (a = 0);
                    1 < a ? z = !1 : (z = !0, d(j("jwthumb"), {height: Math.max(B.clientHeight * a, M.height + F.height)}));
                    d(j(), {visibility: z ? "visible" :
                        "hidden"});
                    l && (l.style.width = z ? l.parentElement.clientWidth - C.width + "px" : "")
                } else T = setTimeout(L, 10)
            }, 0)
        }, X = this.thumbPosition = function (a) {
            isNaN(a) && (a = 0);
            w = Math.max(0, Math.min(1, a));
            d(j("jwthumb"), {top: G + (B.clientHeight - t.clientHeight) * w});
            l && (l.style.top = (n.clientHeight - l.scrollHeight) * w + "px")
        };
        n = q("jwslider", null, h);
        n.id = f;
        n.addEventListener("mousedown", function (c) {
            0 == c.button && (y = !0);
            a.onselectstart = function () {
                return!1
            };
        ...
        E = m("sliderCapBottom");
        C = m("sliderRail");
        f = m("sliderRailCapTop");
        g = m("sliderRailCapBottom");
        h = m("sliderThumb");
        M = m("sliderThumbCapTop");
        F = m("sliderThumbCapBottom");
        G = I.height;
        N = E.height;
        d(j(), {width: C.width});
        d(j("jwrail"), {top: G, bottom: N});
        d(j("jwthumb"), {top: G});
        I = q("jwslidertop", I, n);
        E = q("jwsliderbottom", E, n);
        B = q("jwrail", null, n);
        t = q("jwthumb", null, n);
        I.addEventListener("mousedown", v(-1), !1);
        E.addEventListener("mousedown", v(1), !1);
        q("jwrailtop",
            f, B);
        q("jwrailback", C, B, !0);
        q("jwrailbottom", g, B);
        d(j("jwrailback"), {top: f.height, bottom: g.height});
        q("jwthumbtop", M, t);
        q("jwthumbback", h, t, !0);
        q("jwthumbbottom", F, t);
        d(j("jwthumbback"), {top: M.height, bottom: F.height});
        L();
        l && (l.addEventListener("mousewheel", p, !1), l.addEventListener("DOMMouseScroll", p, !1));
        return this
    };
    d(h("jwslider"), {position: "absolute", height: "100%", visibility: "hidden", right: 0, top: 0, cursor: "pointer", "z-index": 1, overflow: "hidden"});
    d(h("jwslider") + " *", {position: "absolute", width: "100%",
        "background-position": "center", "background-size": "100% 100%", overflow: "hidden"});
...
(function (f) {
    ...
    f.rightclick = function (b, c) {
        ...
        var r, l = h.extend({aboutlink: "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + f.version + "\x26m\x3dh\x26e\x3do", abouttext: "About JW Player " + f.version + "..."}, c), j = !1, q, m;
        this.element = function () {
            return q
        };
        ...
        r = d.getElementById(b.id);
        q = e(".jwclick");
        q.id = b.id + "_menu";
        q.style.display = a;
        r.oncontextmenu = function (b) {
            if (!j) {
                null == b && (b = window.event);
                var c = h.bounds(r), d = c.top, c = c.left;
                q.style.display = a;
                q.style.left = b.pageX - c + "px";
                q.style.top = b.pageY - d + "px";
...
(function (f) {
    ...
    f.setup = function (g, h) {
        function l(a, b, c) {
            x.push({name: a, method: b, depends: c})
        }
        ...
        function s(a) {
            n.setPlaylist(a);
            0 == n.playlist[0].sources.length ? A("Error loading playlist: No playable sources found") : t[c] = !0
        }
        ...
        function A(a) {
            D = !0;
            w.sendEvent(d.JWPLAYER_ERROR, {message: a});
            B.setupError(a)
        }

        var n = g, B = h, t = {}, y, w = new d.eventdispatcher, D = !1, x = [];
        e.extend(this, w);
        this.start = j;
        l(1, function () {
        ...
        l(b, function () {
            y = new f.skin;
            y.load(n.config.skin,
                q, m)
        }, 1);
        l(c, function () {
            switch (e.typeOf(n.config.playlist)) {
                case "string":
                    var b = new f.playlistloader;
                    b.addEventListener(d.JWPLAYER_PLAYLIST_LOADED, p);
                    b.addEventListener(d.JWPLAYER_ERROR, v);
                    b.load(n.config.playlist);
                    break;
                case "array":
                    s(new a(n.config.playlist))
            }
        }, 1);
        l(k, function () {
            var a = n.playlist[n.item].image;
            if (a) {
                var b = new Image;
    ...
    f.skinloader = function (a, b, c) {
        function k(a) {
            ...
            h.ajax(h.getAbsolutePath(A), function (a) {
                try {
                    h.exists(a.responseXML) && r(a.responseXML)
                } catch (b) {
                    s(d)
                }
            }, function (a) {
        ...
        function r(a) {
            ...
            if (0 === a.length)p(m); else for (b = 0; b < a.length; b++) {
                var c =
                    q(a[b].getAttribute("name")), d = {settings: {}, elements: {}, layout: {}}, e = g(g(a[b], "elements")[0], "element");
                m[c] = d;
                for (var f = 0; f < e.length; f++)j(e[f], c);
                if ((c = g(a[b], "settings")[0]) && 0 < c.childNodes.length) {
                    c = g(c, "setting");
                    for (e = 0; e < c.length; e++) {
                        var f = c[e].getAttribute("name"), k = c[e].getAttribute("value");
                ...
                if ((c = g(a[b], "layout")[0]) && 0 < c.childNodes.length) {
                    ...
                    for (e = 0; e < c.length; e++) {
                        k = c[e];
                        f = {elements: []};
                        d.layout[q(k.getAttribute("position"))] =
                            f;
                        ...
                        for (n = 0; n < k.length; n++) {
                            r = k[n];
                            f.elements.push({type: r.tagName});
                            for (var u = 0; u < r.attributes.length; u++) {
                                var A = r.attributes[u];
                                f.elements[n][q(A.name)] = A.value
                            }
                            h.exists(f.elements[n].name) || (f.elements[n].name = r.tagName)
                        }
                    }
                }
                v = !1;
            ...
            n || (u = setInterval(function () {
                ...
                e(m, function (b, c) {
                    "properties" != b && e(c.elements, function (c) {
                        (m[q(b)] ? m[q(b)].elements[q(c)] : null).ready || (a = !1)
                    })
                });
                a && !1 == v && (clearInterval(u), p(m))
            }, 100))
        }

        function j(a, b) {
            b = q(b);
            var c = new Image, d = q(a.getAttribute("name")), e = a.getAttribute("src");
            if (0 !== e.indexOf("data:image/png;base64,"))var f = h.getAbsolutePath(A), e = [f.substr(0, f.lastIndexOf("/")), b, e].join("/");
            m[b].elements[d] = {height: 0, width: 0, src: "", ready: !1, image: c};
            c.onload = function () {
                var a = b, e = m[q(a)] ? m[q(a)].elements[q(d)] : null;
                e ? (e.height = c.height, e.width = c.width, e.src = c.src, e.ready = !0, l()) : h.log("Loaded an image for a missing element: " + a + "." + d)
            };
            c.onerror =
                function () {
                    n = !0;
        ...
        var m = {}, p = b, s = c, v = !0, u, A = a, n = !1;
        "string" != typeof A || "" === A ? r(f.defaultskin().xml) : "xml" != h.extension(A) ? s("Skin not a valid file type") : new f.skinloader("", k, s)
    }
})(jwplayer.html5);
(function (f) {
    ...
    f.thumbs = function (a) {
        ...
        function k(a) {
            a = a.target;
            d("#" + j, {"background-image": a.src, "background-position": "0 0", width: a.width, height: a.height})
        }
        ...
        this.load = function (a) {
            ...
            a && (l = a.split("?")[0].split("/").slice(0, -1).join("/"),
                (new f.parsers.srt(b, c, !0)).load(a))
        };
        this.element = function () {
            return g
        };
        this.updateTimeline = function (a) {
            var b = 0;
            if (r) {
                for (; b < r.length && a > r[b].end;)b++;
                b == r.length && b--;
                if (r[b].text)if (a = r[b].text, 0 > a.indexOf("://") && (a = l ? l + "/" + a : a), 0 < a.indexOf("#xywh"))try {
                    var e = /(.+)\#xywh=(\d+),(\d+),(\d+),(\d+)/.exec(a), f = e[1];
                    d("#" + j, {"background-image": f, "background-position": -1 * e[2] + "px " + -1 * e[3] + "px", width: e[4], height: e[5]})
                } catch (g) {
...
(function (f) {
    ...
    f.html5.video = function (a) {
        ...
        function f() {
            F && (z == d.PLAYING && !x) && (t = Number(n.currentTime.toFixed(1)), b(e.JWPLAYER_MEDIA_TIME, {position: t, duration: B}))
        }

        function g(a) {
            F && (y || (y = !0, w || (w = !0, b(e.JWPLAYER_MEDIA_BUFFER_FULL))), "loadedmetadata" == a.type && (n.muted && (n.muted = !1, n.muted = !0), b(e.JWPLAYER_MEDIA_META, {duration: n.duration, height: n.videoHeight, width: n.videoWidth})))
        }

        function r(a) {
            F && !x && (n.paused ? n.currentTime ==
                n.duration && 3 < n.duration || da() : (!h.isFF() || !("play" == a.type && z == d.BUFFERING)) && m(d.PLAYING))
        }
        ...
        function q() {
            ...
            n.load();
            E = setInterval(p, 100);
            if ((h.isIPod() || h.isAndroid(2.3)) && !w)w = !0, b(e.JWPLAYER_MEDIA_BUFFER_FULL)
        }

        function m(a) {
            if (!(a == d.PAUSED && z == d.IDLE) && !x && z != a) {
                var c = z;
                z = a;
        ...
        function p() {
            if (F) {
                var a;
                a = 0 == n.buffered.length || 0 == n.duration ? 0 : n.buffered.end(n.buffered.length - 1) / n.duration;
                a != C && (C = a, b(e.JWPLAYER_MEDIA_BUFFER, {bufferPercent: Math.round(100 * C)}));
                1 <= a && clearInterval(E)
            }
        }
        ...
        var s = h.isIE(), v = {abort: c, canplay: g, canplaythrough: c, durationchange: function () {
            if (F) {
                var a = Number(n.duration.toFixed(1));
                B != a && (B = a);
                T && (0 < D && a > D) && Z(D);
                f()
            }
        }, emptied: c, ended: function () {
            F && z != d.IDLE && (N = -1, X = !0, b(e.JWPLAYER_MEDIA_BEFORECOMPLETE),
                F && (m(d.IDLE), X = !1, b(e.JWPLAYER_MEDIA_COMPLETE)))
        }, error: function () {
            //F && (h.log("Error playing media: %o", n.error), M.sendEvent(e.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"}), m(d.IDLE))
        }, loadeddata: c, loadedmetadata: g, loadstart: c, pause: r, play: r, playing: r, progress: function () {
            y && (0 < D && !T) && (s ? setTimeout(function () {
                Z(D)
            }, 200) : Z(D))
        }, ratechange: c, readystatechange: c, seeked: function () {
            !x && z != d.PAUSED && m(d.PLAYING)
        }, seeking: s ? l : c, stalled: c, suspend: c, timeupdate: f, volumechange: function () {
            b(e.JWPLAYER_MEDIA_VOLUME,
                {volume: Math.round(100 * n.volume)});
            b(e.JWPLAYER_MEDIA_MUTE, {mute: n.muted})
        }, waiting: l}, u, A, n, B, t, y, w, D, x, z = d.IDLE, I, E = -1, C = -1, M = new e.eventdispatcher, F = !1, G, N = -1, T = h.isAndroid(), L = this, X = !1;
        h.extend(L, M);
        L.load = function (a) {
            if (F) {
                u = a;
                D = 0;
                B = a.duration ? a.duration : -1;
                t = 0;
                G = u.sources;
                0 > N && (N = 0);
                for (a = 0; a < G.length; a++)if (G[a]["default"]) {
                    N = a;
                    break
                }
                var b = h.getCookies().qualityLabel;
                if (b)for (a = 0; a < G.length; a++)if (G[a].label == b) {
                    N = a;
                    break
                }
                (a = j(G)) && M.sendEvent(e.JWPLAYER_MEDIA_LEVELS, {levels: a, currentQuality: N});
                q()
            }
        };
        L.stop = function () {
            F && (n.removeAttribute("src"), s || n.load(), N = -1, clearInterval(E), m(d.IDLE))
        };
        L.play = function () {
            F && !x && n.play()
        };
        var da = L.pause = function () {
            F && (n.pause(), m(d.PAUSED))
        };
        L.seekDrag = function (a) {
            F && ((x = a) ? n.pause() : n.play())
        };
        var Z = L.seek = function (a) {
            F && (!x && 0 == D && b(e.JWPLAYER_MEDIA_SEEK, {position: t, offset: a}), y ? (D = 0, n.currentTime = a) : D = a)
        }, oa = L.volume = function (a) {
            h.exists(a) && (n.volume = Math.min(Math.max(0, a / 100), 1), I = 100 * n.volume)
        };
        L.mute = function (a) {
            h.exists(a) || (a = !n.muted);
            a ? (I =
                100 * n.volume, n.muted = !0) : (oa(I), n.muted = !1)
        };
        ...
        L.attachMedia = function (a) {
            F = !0;
            a || (y = !1);
            X && (m(d.IDLE), b(e.JWPLAYER_MEDIA_COMPLETE), X = !1)
        };
        L.getTag = function () {
            return n
        };
        L.audioMode = function () {
            if (!G)return!1;
            var a = G[0].type;
            return"aac" == a || "mp3" == a || "vorbis" == a
        };
        L.setCurrentQuality = function (a) {
            N != a && (a = parseInt(a), 0 <= a && (G && G.length > a) && (N = a, h.saveCookie("qualityLabel", G[a].label), b(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {currentQuality: a,
                levels: j(G)}), a = n.currentTime, q(), L.seek(a)))
        };
        L.getCurrentQuality = function () {
            return N
        };
        L.getQualityLevels = function () {
            return j(G)
        };
        n = a;
        h.foreach(v, function (a, b) {
            n.addEventListener(a, b, !1)
        });
        n.controls = !0;
        n.controls = !1;
...
(function (f) {
    var h = jwplayer.utils, e = jwplayer.events, d = e.state, a = h.css, b = h.isMobile(), c = h.isIPad(), k = h.isIPod(), g = h.isAndroid(), r = h.isIOS(), l = document, j = "aspectMode", q = "jwmain", m = "jwvideo", p = "jwplaylistcontainer", s = !0, v = !1, u = "hidden", A = "none", n = "block";
    f.view = function (B, t) {
        function y(a) {
            a && (a.element().addEventListener("mousemove", x, v), a.element().addEventListener("mouseout", z, v))
        }
        ...
        function D() {
            clearTimeout(pa);
            if (S.jwGetState() ==
                d.PLAYING || S.jwGetState() == d.PAUSED)oa(), Aa || (pa = setTimeout(I, Da))
        }
        ...
        function I() {
            S.jwGetState() != d.BUFFERING && (H && (!V && !O) && H.hide(), U && (!ia && !O) && U.hide(), X());
            clearTimeout(pa);
            pa = 0
        }

        function E(a) {
            ba.sendEvent(a.type, a)
        }
        ...
        function C(b, c, d) {
            ...
            -1 == P.className.indexOf(j) && (P.style.height = isNaN(c) ? c : c + "px");
            R && R.redraw();
            H && H.redraw();
            W && (W.offset(H && 0 <=
                W.position().indexOf("bottom") ? H.height() + H.margin() : 0), setTimeout(function () {
                U && U.offset("top-left" == W.position() ? W.element().clientWidth + W.margin() : 0)
            }, 500));
            b = J.playlistsize;
            var f = J.playlistposition;
            M(c);
            if (K && b && ("right" == f || "bottom" == f)) {
                K.redraw();
                c = {display: n};
                var g = {};
                c[f] = 0;
            ...
            F();
            d && ba.sendEvent(e.JWPLAYER_RESIZE)
        }

        function M(a) {
            V = b && !O ? v : 0 < a.toString().indexOf("%") ? v : "bottom" == J.playlistposition ? a <= 40 + J.playlistsize : 40 >= a;
            H && (V ? (H.audioMode(s),
                oa(), R.hidePreview(s), Z(), ea(v)) : (H.audioMode(v), Pa(S.jwGetState())));
            W && V && X();
            P.style.backgroundColor = V ? "transparent" : "#000"
        }

        function F() {
            Y && -1 == P.className.indexOf(j) && h.stretch(J.stretching, Y, ja.clientWidth, ja.clientHeight, Y.videoWidth, Y.videoHeight)
        }
        ...
        function N(a) {
            r || (a ? (P.className += " jwfullscreen", l.getElementsByTagName("body")[0].style["overflow-y"] = u) : (P.className = P.className.replace(/\s+jwfullscreen/, ""), l.getElementsByTagName("body")[0].style["overflow-y"] =
                ""))
        }
        ...
        function T() {
            var a;
            a:{
                a = [l.mozFullScreenElement, l.webkitCurrentFullScreenElement, Y.webkitDisplayingFullscreen];
                for (var b = 0; b < a.length; b++)if (a[b] && (!a[b].id || a[b].id == S.id)) {
                    a = s;
                    break a
                }
                a = v
        ...
        function da() {
            R && J.controls && !V && (!k || S.jwGetState() == d.IDLE) && R.show();
            if (b && !O && (g && (aa.style.display = n), !b || !J.fullscreen))Y.controls = !1
        }

        function Z() {
            R && (b && !O && (g && J.controls && (aa.style.display = A), Y.controls =
                J.controls), R.hide())
        }

        function oa() {
            if (J.controls || V)H && H.show(), L();
            W && !V && W.show()
        }

        function ea(b) {
            b = b && !V;
            a(fa(m), {visibility: b ? "visible" : u, opacity: b ? 1 : 0})
        }
        ...
        function Pa(a) {
            switch (a) {
                case d.PLAYING:
                    !J.getVideo().audioMode() || b ? (ea(s), F(), R.hidePreview(s), b && (!c || !O) && Z()) : (ea(v), R.hidePreview(V));
                    D();
                    break;
                case d.IDLE:
                    ea(v);
                    I();
                    V || (R.hidePreview(v), da(), ca.hide ||
                        W && !V && W.show());
                    break;
                case d.BUFFERING:
                    da();
        ...
        var S = B, J = t, P, va, aa, Ga, za, pa = 0, Da = 2E3, Y, ja, qa, Q, H, R, U, W, ca = h.extend({}, J.componentConfig("logo")), ga, K, V, O = J.mobilecontrols, $ = v, ia, wa, sa, Aa = v, ba = new e.eventdispatcher;
        h.extend(this, ba);
        this.getCurrentCaptions = function () {
        ...
        this.setup = function (c) {
            if (!$) {
                ...
                Y = J.getVideo().getTag();
                ja.appendChild(Y);
                aa = w("span", "jwcontrols");
                qa = w("span", "jwinstream");
                za = w("span", p);
                Ga = w("span", "jwaspect");
                c = J.height;
                ...
                ga.addEventListener(e.JWPLAYER_CAPTIONS_LIST, E);
                ga.addEventListener(e.JWPLAYER_CAPTIONS_CHANGED, E);
                aa.appendChild(ga.element());
                R = new f.display(S,
                    k);
                R.addEventListener(e.JWPLAYER_DISPLAY_CLICK, E);
                V && R.hidePreview(s);
                aa.appendChild(R.element());
                W = new f.logo(S, ca);
                aa.appendChild(W.element());
                U = new f.dock(S, J.componentConfig("dock"));
                aa.appendChild(U.element());
                wa = S.edition ? new f.rightclick(S, {abouttext: J.abouttext, aboutlink: J.aboutlink}) : new f.rightclick(S, {});
                J.playlistsize && (J.playlistposition && J.playlistposition != A) && (K = new f.playlistcomponent(S, {}), za.appendChild(K.element()));
                if (!b || O)H = new f.controlbar(S, g), aa.appendChild(H.element()),
                    O && oa();
                setTimeout(function () {
                    C(J.width, J.height, !1)
                }, 0);
                va.appendChild(ja);
                va.appendChild(aa);
                va.appendChild(qa);
                ...
                P.appendChild(Ga);
                P.appendChild(za);
                l.addEventListener("webkitfullscreenchange", T, v);
                Y.addEventListener("webkitbeginfullscreen", T, v);
                Y.addEventListener("webkitendfullscreen", T, v);
                l.addEventListener("mozfullscreenchange", T, v);
                l.addEventListener("keydown", G, v);
                S.jwAddEventListener(e.JWPLAYER_PLAYER_READY, Ua);
                S.jwAddEventListener(e.JWPLAYER_PLAYER_STATE, Fa);
                S.jwAddEventListener(e.JWPLAYER_PLAYLIST_COMPLETE,
                    Ta);
                Fa({newstate: d.IDLE});
                ...
                aa.addEventListener("mousemove", D, v);
                h.isIE() && (ja.addEventListener("mousemove", D, v), ja.addEventListener("click", R.clickHandler));
                y(H);
                y(U);
                y(W);
                a("#" + P.id + "." + j + " .jwaspect", {"margin-top": J.aspectratio, display: n});
                c = h.exists(J.aspectratio) ? parseFloat(J.aspectratio) : 100;
                g = J.playlistsize;
                a("#" + P.id + ".playlist-right .jwaspect", {"margin-bottom": -1 * g * (c / 100) + "px"});
                a("#" + P.id + ".playlist-right ." +
                    p, {width: g + "px", right: 0, top: 0, height: "100%"});
                a("#" + P.id + ".playlist-bottom .jwaspect", {"padding-bottom": g + "px"});
                a("#" + P.id + ".playlist-bottom ." + p, {width: "100%", height: g + "px", bottom: 0});
        ...
        var Ba = this.fullscreen = function (a) {
            ...
            a ? J.fullscreen || (N(s), P.requestFullScreen ? P.requestFullScreen() : P.mozRequestFullScreen ? P.mozRequestFullScreen() : P.webkitRequestFullScreen && P.webkitRequestFullScreen(),
                J.setFullscreen(s)) : (N(v), J.fullscreen && (J.setFullscreen(v), l.cancelFullScreen ? l.cancelFullScreen() : l.mozCancelFullScreen ? l.mozCancelFullScreen() : l.webkitCancelFullScreen ? l.webkitCancelFullScreen() : Y.webkitExitFullScreen && Y.webkitExitFullScreen()), c && S.jwGetState() == d.PAUSED && setTimeout(da, 500));
            H && H.redraw();
            R && R.redraw();
            U && U.redraw();
            F();
            ...
            setTimeout(function () {
                    ...
                    J.width = a.width;
                    J.height = a.height;
                    ba.sendEvent(e.JWPLAYER_RESIZE)
                },
                0)
        };
        this.resize = C;
        ...
        this.setupInstream = function (a, c) {
            ...
            b && (Q = S.jwGetControls(), S.jwSetControls(v))
        };
        ...
        this.setControls = function (a) {
            ...
            a = a ? s : v;
            J.controls = a;
            a != b && (a ? da() : (H && (!V && !O) && H.hide(), U && (!ia && !O) && U.hide(), X(), Z()), ba.sendEvent(e.JWPLAYER_CONTROLS, {controls: a}))
        };
        this.forceState = function (a) {
            R.forceState(a)
        };
        ...
        this.getSafeRegion = function () {
            var a = J.controls, b = h.bounds(va), c = b.top, d = h.bounds(H ? H.element() : null), e = 0 < U.numButtons(),
                f = h.bounds(U.element()), g = h.bounds(W.element()), j = 0 == W.position().indexOf("top"), e = Math.max(e ? f.top + f.height - c : 0, j ? g.top + g.height - c : 0), f = b.width, b = d.height ? (j ? d.top : g.top) - e - c : b.height - e;
            return{x: 0, y: a ? e : 0, width: a ? f : 0, height: a ? b : 0}
        };
        this.destroy = function () {
            l.removeEventListener("webkitfullscreenchange", T, v);
            l.removeEventListener("mozfullscreenchange", T, v);
            Y.removeEventListener("webkitbeginfullscreen", T, v);
            Y.removeEventListener("webkitendfullscreen", T, v);
            l.removeEventListener("keydown", G, v);
            wa && wa.destroy()
        };
        P = w("div", "jwplayer playlist-" + J.playlistposition);
        P.id = S.id;
        J.aspectratio && (a(".jwplayer", {display: "inline-block"}), P.className = P.className.replace("jwplayer", "jwplayer " + j));
        C(J.width, J.height);
    ...
    a("." + q, {position: "absolute",
        left: 0, right: 0, top: 0, bottom: 0, "-webkit-transition": "opacity .5s ease", "-moz-transition": "opacity .5s ease", "-o-transition": "opacity .5s ease"});
    a("." + m + " ,.jwcontrols", {position: "absolute", height: "100%", width: "100%", "-webkit-transition": "opacity .5s ease", "-moz-transition": "opacity .5s ease", "-o-transition": "opacity .5s ease"});
    a("." + m, {overflow: u, visibility: u, opacity: 0, cursor: "pointer"});
    a("." + m + " video", {background: "transparent", width: "100%", height: "100%"});
    a("." + p, {position: "absolute", height: "100%",
        width: "100%", display: A});
    a(".jwinstream", {position: "absolute", top: 0, left: 0, bottom: 0, right: 0, display: "none"});
    a(".jwaspect", {display: "none"});
    a(".jwplayer." + j, {height: "auto"});
...
(function (f) {
    ...
    f.rightclick = function (d, a) {
        if ("free" == d.edition())a.aboutlink = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + f.version + "\x26m\x3dh\x26e\x3df", delete a.abouttext; else {
            if (!a.aboutlink) {
                var b = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + f.version + "\x26m\x3dh\x26e\x3d", c = d.edition();
