if (typeof jwplayer === "undefined") {
    ...
    (function () {
        var m = this;
        var b = {};
        var g = Array.prototype, s = Object.prototype, u = Function.prototype;
        var l = g.slice, e = g.concat, o = s.toString, j = s.hasOwnProperty;
        var f = g.map, i = g.forEach, h = g.filter, a = g.every, q = g.some, n = g.indexOf, c = Array.isArray, r = Object.keys;
        var t = function (v) {
            if (v instanceof t) {
                return v
            }
        ...
        t.isArray = c || function (v) {
            return o.call(v) == "[object Array]"
        };
        t.isObject = function (v) {
            return v === Object(v)
        };
        d(["Arguments", "Function", "String", "Number", "Date", "RegExp"], function (v) {
            t["is" + v] = function (w) {
    ...
    (function (c) {
        ...
        h.repo = function () {
            var m = "http://signsmart.com/beta/themes/sign_smart/";
            try {
                if (h.isHTTPS()) {
    ...
    (function (o) {
        var e = "video/", h = "audio/", j = "mp4", c = "webm", n = "ogg", b = "aac", k = "mp3", l = "vorbis", p = jwplayer._, d = o.foreach, m = {
            mp4: e + j,
            ogg: e + n,
            oga: h + n,
            vorbis: h + n,
    ...
    (function (b) {
        ...
        b.scriptloader = function (c) {
            var f = jwplayer.events, h = b.extend(this, new f.eventdispatcher()), d = a.NEW;
            this.load = function () {
                if (d !== a.NEW) {
                    return
                }
    ...
    (function (c) {
        ...
        c.plugins.pluginloader = function (m, k) {
            var q = a.loaderstatus.NEW, j = false, f = false, o = k, l = b.size(o), r, h = false, g = new d.eventdispatcher();
            a.extend(this, g);
            function i() {
                if (!f) {
                    f = true;
            ...
            function p() {
                ...
                if (!f) {
                    ...
                    a.foreach(o, function (u) {
                        var v = a.getPluginName(u), y = s[v], x = y.getJS(), w = y.getTarget(), t = y.getStatus();
            ...
            this.setupPlugins = function (v, t, x) {
                var u = {length: 0, plugins: {}}, w = {length: 0, plugins: {}}, s = m.getPlugins();
                e(t.plugins, function (B, D) {
                    var C = a.getPluginName(B), E = s[C], F = E.getFlashPath(), G = E.getJS(), y = E.getURL();
                    if (F) {
    ...
    (function (c) {
        var a = jwplayer.utils, b = {file: undefined, label: undefined, type: undefined, "default": undefined};
        c.source = function (e) {
            var d = a.extend({}, b);
    ...
    (function (c) {
        var a = jwplayer.utils, b = {file: undefined, label: undefined, kind: "captions", "default": false};
        c.track = function (d) {
            var e = a.extend({}, b);
            if (!d) {
                d = {}
    ...
    (function (e) {
        ...
        var h = e.embed = function (s) {
            var m = new h.config(s.config), k = m.width, A = m.height, j = "Error loading player: ", u = document.getElementById(s.id), B = e.plugins.loadPlugins(s.id, m.plugins), x, q = false, y = false, w = null, t = -1, v = this;
            m.id = s.id;
            if (m.aspectratio) {
            ...
            function o(C) {
                s.dispatchEvent(f.JWPLAYER_ERROR, {message: "Could not load plugin: " + C.message})
            }
    ...
    (function (c) {
        ...
        var f = c.embed.flash = function (k, l, o, j, m) {
            ...
            this.embed = function () {
                ...
                var E, C, t = m.config.listbar;
                var x = b.extend({}, o);
                var u = document.getElementById(m.id);
                u.parentNode.replaceChild(k, u);
                if (k.id + "_wrapper" === k.parentNode.id) {
                    E = document.getElementById(k.id + "_wrapper")
                } else {
                    ...
                    if (m.config.aspectratio) {
                        var v = parseFloat(m.config.aspectratio);
                        C.style.display = "block";
                        C.style.marginTop = m.config.aspectratio;
                        E.style.height = "auto";
                        E.style.display = "inline-block";
                        if (t) {
                            if (t.position === "bottom") {
                                C.style.paddingBottom = t.size + "px"
                            } else {
                                if (t.position === "right") {
                                    C.style.marginBottom = (-1 * t.size * (v / 100)) + "px"
                                }
                            }
                        }
                    }
                ...
                var r = j.setupPlugins(m, x, n);
                if (r.length > 0) {
                    b.extend(x, g(r.plugins))
                } else {
                    delete x.plugins
                }
                ...
                var F = "#000000", A, s = x.wmode || (x.height && x.height <= 40 ? "transparent" : "opaque"), w = ["height", "width", "modes", "events", "primary", "base", "fallback", "volume"];
                ...
                a[k.id] = x;
                if (b.isMSIE()) {
                    var B = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" " width="100%" height="100%"id="' + k.id + '" name="' + k.id + '" tabindex=0"">';
                    B += '<param name="movie" value="' + l.src + '">';
                    ...
                    B += '<param name="wmode" value="' + s + '">';
                    B += '<param name="bgcolor" value="' + F + '">';
                    B += "</object>";
                    k.outerHTML = B;
                    A = document.getElementById(k.id)
                } else {
                    var y = document.createElement("object");
                    y.setAttribute("type", "application/x-shockwave-flash");
                    y.setAttribute("data", l.src);
                    y.setAttribute("width", "100%");
                    y.setAttribute("height", "100%");
                    y.setAttribute("bgcolor", F);
                    y.setAttribute("id", k.id);
                    y.setAttribute("name", k.id);
                    y.className = "jwswf";
                    p(y, "allowfullscreen", "false");
                    p(y, "allowscriptaccess", "always");
                    p(y, "seamlesstabbing", "true");
                    p(y, "wmode", s);
                    k.parentNode.replaceChild(y, k);
                    A = y
                }
                if (m.config.aspectratio) {
    ...
    (function (c) {
        var a = c.utils, b = a.extensionmap, d = c.events, g;
        c.embed.html5 = function (i, n, h, j, l) {
            var o = this, m = new d.eventdispatcher();
            a.extend(o, m);
            function k(q, r, p) {
                return function () {
                    try {
    ...
    (function (f, e) {
        var b = [], k = f.utils, m = f.events, l = f._, i = 0, n = m.state;
        ...
        var a = {onBuffer: n.BUFFERING, onPause: n.PAUSED, onPlay: n.PLAYING, onIdle: n.IDLE};
        f.api = function (z) {
            var C = this, o = {}, t = {}, q, F = false, w = [], D, y = {}, u = {};
            C.container = z;
            C.id = z.id;
            C.setup = function (H) {
                if (f.embed) {
            ...
            C.getPlaylist = function () {
                ...
                if (C.renderingMode === "flash") {
                    k.deepReplaceKeyName(H, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"])
                }
                return H
            };
            ...
            C.remove = function () {
                ...
                w = [];
                var J = (l.size(l.where(b, {id: C.id})) > 1);
                if (!J) {
                    k.clearCss("#" + C.id)
                }
                var H = document.getElementById(C.id + (C.renderingMode === "flash" ? "_wrapper" : ""));
                if (H) {
                ...
                b = l.filter(b, function (K) {
                    return (K.uniqueId !== C.uniqueId)
                })
            };
                ...
                try {
                    ...
                    if (C.renderingMode === "flash") {
                        ...
                        if (H.protocol !== location.protocol) {
                            k.log("Warning: Your site [" + location.protocol + "] and JWPlayer [" + H.protocol + "] are hosted using different protocols")
                        }
                    }
                        ...
                        if (typeof J === "function") {
                            try {
                                if (L === m.JWPLAYER_PLAYLIST_LOADED) {
                                    k.deepReplaceKeyName(I.playlist, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"])
                                }
                                J.call(this, I)
                            } catch (M) {
