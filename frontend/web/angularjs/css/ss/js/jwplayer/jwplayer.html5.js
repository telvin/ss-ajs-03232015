(function (b) {
    ...
    e(a + "," + a + "*", {"box-sizing": "content-box"});
    e(a + "* button," + a + "* input," + a + "* select," + a + "* textarea", {"box-sizing": "border-box"});
    e(a + "ul", {"list-style": "none"});
    e(".jwplayer .jwcontrols", {"pointer-events": "none"});
    e(".jwplayer.jw-user-inactive .jwcontrols", {"pointer-events": "all"});
...
(function (a) {
    ...
    a.timeFormat = function (e) {
        if (e > 0) {
            var d = Math.floor(e / 3600), f = Math.floor((e - d * 3600) / 60), c = Math.floor(e % 60);
    ...
    a.bounds = function (d) {
        var g = {left: 0, right: 0, width: 0, height: 0, top: 0, bottom: 0};
...
(function (a) {
    var b = a.stretching = {NONE: "none", FILL: "fill", UNIFORM: "uniform", EXACTFIT: "exactfit"};
    ...
    a.stretch = function (j, n, m, h, l, i) {
        ...
        j = j || b.UNIFORM;
        var d = Math.ceil(m / 2) * 2 / l, g = Math.ceil(h / 2) * 2 / i, e = (n.tagName.toLowerCase() === "video"), f = false, k = "jw" + j.toLowerCase();
...
(function (b) {
    ...
    var f = {
        ...
        setState: function (h) {
            ...
            this.state = h;
            this.sendEvent(d.JWPLAYER_PLAYER_STATE, {oldstate: g, newstate: h})
        }
    };
...
(function (b) {
    var j = b.utils, k = b._, o = b.events, q = o.state, m = window.clearInterval, f = b.html5.DefaultProvider, p = j.isMSIE(), h = j.isMobile(), g = j.isSafari(), e = j.isAndroidNative(), c = j.isIOS(7);
    ...
    function i(ag) {
        ...
        function ai(an) {
            ...
            if (t.state === q.PLAYING && !T) {
                ...
                t.sendEvent(o.JWPLAYER_MEDIA_TIME, {position: B, duration: am})
            }
        }

        function W() {
            t.sendEvent(o.JWPLAYER_MEDIA_META, {duration: J.duration, height: J.videoHeight, width: J.videoWidth})
        }
        ...
        function z() {
            ...
            t.sendEvent(o.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"});
            t.setState(q.IDLE)
        }
        ...
        function v(ao) {
            var an = x(ao);
            if (an) {
                t.sendEvent(o.JWPLAYER_MEDIA_LEVELS, {levels: an, currentQuality: S})
            }
        }
        ...
        this.seek = function (ao) {
            ...
            if (!T && ae === 0) {
                this.sendEvent(o.JWPLAYER_MEDIA_SEEK, {position: B, offset: ao})
            }
            if (ak) {
                ae = 0;
                try {
        ...
        function w() {
            t.sendEvent(o.JWPLAYER_MEDIA_VOLUME, {volume: Math.round(J.volume * 100)});
            t.sendEvent(o.JWPLAYER_MEDIA_MUTE, {mute: J.muted})
        }
        ...
        function u() {
            ...
            if (an !== X) {
                X = an;
                t.sendEvent(o.JWPLAYER_MEDIA_BUFFER, {bufferPercent: Math.round(X * 100)})
            }
        }
        ...
        function s(an) {
            t.sendEvent("fullscreenchange", {target: an.target, jwstate: al})
        }
        ...
        this.setVisibility = function (an) {
            an = !!an;
            if (an || e) {
                j.css.style(M, {visibility: "visible", opacity: 1})
            } else {
                j.css.style(M, {visibility: "", opacity: 0})
            }
        };
        ...
        this.setCurrentQuality = function (ap) {
            ...
            if (ap >= 0) {
                if (V && V.length > ap) {
                    ...
                    this.sendEvent(o.JWPLAYER_MEDIA_LEVEL_CHANGED, {currentQuality: ap, levels: x(V)});
...
(function (c) {
    var f = c.utils, g = c._, i = c.events, j = i.state, d = c.html5.DefaultProvider, a = new f.scriptloader(window.location.protocol + "//www.youtube.com/iframe_api"), e = f.isMobile();

    function b(T) {
        this.state = j.IDLE;
        var J = f.extend(this, new c.events.eventdispatcher("provider." + this.name)), I = window.YT, P = null, B = document.createElement("div"), v, G = -1, A = false, w = null, y = null, t = -1, R = -1, u, F = false, x = e;
        ...
        if (!I && a) {
            a.addEventListener(i.COMPLETE, o);
            a.addEventListener(i.ERROR, C);
            a.load()
        }
        B.id = T + "_youtube";
        function o() {
        ...
        function q() {
            ...
            var U = P.getPlayerState();
            if (U !== null && U !== undefined && U !== R) {
                M({data: U})
            }
            var V = I.PlayerState;
            if (U === V.PLAYING) {
        ...
        function p() {
            s();
            J.sendEvent(i.JWPLAYER_MEDIA_TIME, {position: z(P.getCurrentTime()), duration: P.getDuration()})
        }

        function s() {
            var U = 0;
            if (P && P.getVideoLoadedFraction) {
                U = Math.round(P.getVideoLoadedFraction() * 100)
            }
            if (G !== U) {
                G = U;
                J.sendEvent(i.JWPLAYER_MEDIA_BUFFER, {bufferPercent: U})
            }
        }
        ...
        function N() {
            if (J.state !== j.IDLE) {
                F = true;
                J.sendEvent(i.JWPLAYER_MEDIA_BEFORECOMPLETE);
                J.setState(j.IDLE);
                F = false;
                J.sendEvent(i.JWPLAYER_MEDIA_COMPLETE)
            }
        }

        function L() {
            J.sendEvent(i.JWPLAYER_MEDIA_META, {
        ...
        function m(U, X) {
            ...
            var V = {
                ...
                events: {onReady: O, onStateChange: M, onPlaybackQualityChange: D, onError: n}
            };
        ...
        function M(U) {
            ...
            switch (R) {
                ...
                case V.ENDED:
                    ...
                    return;
                case V.PLAYING:
                    if (g.isFunction(P.unloadModule)) {
                        P.unloadModule("captions")
                    }
                    x = false;
                    L();
                    J.sendEvent(i.JWPLAYER_MEDIA_LEVELS, {
                        levels: J.getQualityLevels(),
                        currentQuality: J.getCurrentQuality()
                    });
                    J.setState(j.PLAYING);
                    return;
                case V.PAUSED:
                    J.setState(j.PAUSED);
                    return;
                case V.BUFFERING:
                    J.setState(j.BUFFERING);
                    return;
                case V.CUED:
                    J.setState(j.IDLE);
                    return
        ...
        function D() {
            J.play();
            J.sendEvent(i.JWPLAYER_MEDIA_LEVEL_CHANGED, {
                currentQuality: J.getCurrentQuality(),
                levels: J.getQualityLevels()
            })
        }
        ...
        function n() {
            J.sendEvent(i.JWPLAYER_MEDIA_ERROR, {message: "Error loading YouTube: Video could not be played"})
        }

        function r() {
            if (e) {
                J.setVisibility(true);
                f.css("#" + T + " .jwcontrols", {display: "none"})
            }
        }

        function Q() {
            f.css("#" + T + " .jwcontrols", {display: ""})
        }
        ...
        function l(V) {
            y = null;
            var U = V.sources[0].file;
            var Y = f.youTubeID(U);
            if (!V.image) {
                V.image = "//i.ytimg.com/vi/" + Y + "/0.jpg"
            }
            J.setVisibility(true);
            if (!I || !P) {
                w = function () {
            ...
            if (X !== Y) {
                ...
                var W = P.getPlayerState();
                var Z = I.PlayerState;
                if (W === Z.UNSTARTED || W === Z.CUED) {
                    r()
                }
            } else {
        ...
        function K() {
            ...
            J.sendEvent(i.JWPLAYER_MEDIA_VOLUME, {volume: Math.round(P.getVolume())});
            J.sendEvent(i.JWPLAYER_MEDIA_MUTE, {mute: P.isMuted()})
        }
        ...
        this.supportsFullscreen = function () {
            return !!(v && (v.requestFullscreen || v.requestFullScreen || v.webkitRequestFullscreen || v.webkitRequestFullScreen || v.webkitEnterFullscreen || v.webkitEnterFullScreen || v.mozRequestFullScreen || v.msRequestFullscreen))
        };
        this.remove = function () {
            H();
            if (B && v && v === B.parentNode) {
                v.removeChild(B)
            }
            w = y = P = null
        };
        this.setVisibility = function (U) {
            U = !!U;
            if (U) {
                f.css.style(B, {display: "block"});
                f.css.style(v, {visibility: "visible", opacity: 1})
            } else {
                if (!e) {
                    f.css.style(v, {opacity: 0})
                }
            }
        };
        this.resize = function (W, V, U) {
            return f.stretch(U, B, W, V, B.clientWidth, B.clientHeight)
        };
        this.checkComplete = function () {
            return F
        };
        this.getCurrentQuality = function () {
            ...
            if (P.getAvailableQualityLevels) {
                var V = P.getPlaybackQuality();
                var U = P.getAvailableQualityLevels();
                return U.indexOf(V)
            }
            return -1
        };
        this.getQualityLevels = function () {
            ...
            if (!g.isFunction(P.getAvailableQualityLevels)) {
                return []
            }
            var V = P.getAvailableQualityLevels();
            if (V.length === 2 && g.contains(V, "auto")) {
                return {label: g.without(V, "auto")}
            }
            var U = g.map(V, function (W) {
                return {label: W}
            });
            return U.reverse()
        };
        this.setCurrentQuality = function (W) {
            if (!P) {
                return
            }
            if (P.getAvailableQualityLevels) {
                var V = P.getAvailableQualityLevels();
                if (V.length) {
                    var U = V[V.length - W - 1];
                    P.setPlaybackQuality(U)
                }
            }
        }
    }
...
(function (b) {
    ...
    b.html5.adskipbutton = function (J, C, o, H) {
        var m, q, D = -1, I = false, B, r = 0, p, u, w = false, z = l.extend(this, new c.eventdispatcher());
        ...
        function s() {
            ...
            m.appendChild(u);
            m.appendChild(p);
            h.style(m, {visibility: "hidden", bottom: C});
        ...
        z.updateSkipTime = function (L, K) {
            n(L, K);
            if (D >= 0) {
                h.style(m, {visibility: B ? "visible" : "hidden"});
                if (D - L > 0) {
                    G(L);
                    if (I) {
                        I = false;
        ...
        z.show = function () {
            B = true;
            if (D > 0) {
                h.style(m, {visibility: "visible"})
            }
        };
        z.hide = function () {
            B = false;
            h.style(m, {visibility: "hidden"})
        };
        function F(L, K) {
    ...
    h("." + d, {position: "absolute", "float": "right", display: "inline-block", width: k, height: i, right: 10});
    h("." + e, {position: "relative", display: "none"})
})(window.jwplayer);
(function (f) {
    var i = f.html5, m = f.utils, o = f.events, p = o.state, n = f.parsers, l = m.css, d = m.isAndroid(4, true), k = "playing", a = ".jwcaptions", b = "absolute", c = "none", j = "100%", g = "hidden", h = "normal", e = "#FFFFFF";
    i.captions = function (M, y) {
        ...
        function O() {
            ...
            E.sendEvent(o.JWPLAYER_CAPTIONS_LOADED, {captionData: aa})
        }
        ...
        function U(ac, ab, aa) {
            var Z = {type: ac, tracks: ab, track: aa};
            E.sendEvent(ac, Z)
        }
    ...
    l(a, {position: b, cursor: "pointer", width: j, height: j, overflow: g})
})(jwplayer);
(function (d) {
    ...
    c.captions.renderer = function (s, i) {
        ...
        function p() {
            if (e === "visible") {
                ...
                if (s.windowOpacity) {
                    a(m, {padding: Math.round(5 * v) + "px", borderRadius: Math.round(5 * v) + "px"})
                }
                a(h, {visibility: e})
            }
        }
        ...
        function j() {
            var u = s.fontOpacity, y = s.windowOpacity, x = s.edgeStyle, v = s.backgroundColor, t = {display: "inline-block"}, w = {
...
(function (i, q, g) {
    var m = i.jwplayer, j = m.html5, v = m.utils, z = m._, b = m.events, f = b.state, p = v.css, w = v.transitionStyle, t = v.isMobile(), e = v.isAndroid(4, true), x = (i.top !== i.self), c = "button", o = "text", h = "divider", r = "slider", y = 250, s = {display: "none"}, k = {display: "block"}, a = {display: ""};
    ...
    j.controlbar = function (bS, ak) {
        ...
        var bT, bH = aU("divider", h), aJ = {
            ...
            layout: {
                left: {
                    position: "left",
                    elements: [aU("play", c), aU("prev", c), aU("next", c), aU("elapsed", o)]
                },
                center: {position: "center", elements: [aU("time", r), aU("alt", o)]},
                right: {
                    position: "right",
                    elements: [aU("duration", o), aU("hd", c), aU("cc", c), aU("mute", c), aU("volume", r), aU("volumeH", r), aU("cast", c), aU("fullscreen", c)]
                }
            }
        ...
        }, bu = {play: false, mute: false, cast: false, fullscreen: ak.fullscreen || false}, af = {
            play: aC,
            mute: bf,
            fullscreen: ae,
            next: bg,
            ...
            cc: aK,
            cast: bp
        }, aq = {time: au, volume: bD}, aW = {}, bm = [], bd = v.extend(this, new b.eventdispatcher());

        function aU(b8, ca, b9) {
            return {name: b8, type: ca, className: b9}
        }
        ...
        function aA(b8) {
            p.block(bU);
            if (aM(b8)) {
                bd.setText(bS.jwGetPlaylist()[bS.jwGetPlaylistIndex()].title || "Live broadcast");
                ab(false)
            } else {
                var b9;
                if (aI.elapsed) {
            ...
            switch (b8.newstate) {
                ...
                case f.PLAYING:
                    if (aI.timeSliderThumb) {
                        p.style(aI.timeSliderThumb, {opacity: 1})
                    }
                    aF("play", true);
                    break;
                case f.PAUSED:
                ...
                case f.IDLE:
                    aF("play", false);
                    if (aI.timeSliderThumb) {
                        p.style(aI.timeSliderThumb, {opacity: 0})
                    }
                    if (aI.timeRail) {
                        aI.timeRail.className = "jwrail"
                    }
                    aN(0);
                    aA({position: 0, duration: 0});
                    break
            }
        }
            ...
            if (!aT) {
                ...
                if (z.isArray(ca) && !t) {
                    for (var cb = 0; cb < ca.length; cb++) {
                        if (!b9 && ca[cb].file && ca[cb].kind && ca[cb].kind.toLowerCase() === "thumbnails") {
                            bG.load(ca[cb].file);
                            b9 = true
                        }
                        if (ca[cb].file && ca[cb].kind && ca[cb].kind.toLowerCase() === "chapters") {
                            ap(ca[cb].file);
                            cc = true
                        }
                    }
        ...
        function aw() {
            return (!!q.querySelector("#" + bS.id + " .jwplaylist") && !bS.jwGetFullscreen())
        }
        ...
        function bz() {
            ...
            var b8 = {height: bE, bottom: b9, left: b9, right: b9, "max-width": a4 ? "" : a8.maxwidth};
            p.style(av, b8);
            p(V(".jwtext"), {
                font: a8.fontsize + "px/" + W("background").height + "px " + a8.font,
                color: a8.fontcolor,
                "font-weight": a8.fontweight
            });
            p(V(".jwoverlay"), {bottom: bE})
        }
        ...
        function ad(b9, cg) {
            ...
            bx(ch, ce);
            var ca = W(b9 + "Button"), cf = W(b9 + "ButtonOver"), ci = W(b9 + "ButtonOff");
            a9(V(".jw" + b9 + " button"), ca, cf, ci);
            var cd = aP[b9];
            if (cd) {
                a9(V(".jw" + b9 + ".jwtoggle button"), W(cd + "Button"), W(cd + "ButtonOver"))
            }
            if (bu[b9]) {
        ...
        function a9(b8, b9, ca, cb) {
            ...
            p(b8, {width: b9.width, background: "url(" + b9.src + ") no-repeat center", "background-size": u(b9)});
            if (ca.src && !t) {
            ...
            if (cb && cb.src) {
                p(b8 + ".off", {background: "url(" + cb.src + ") no-repeat center", "background-size": u(cb)})
            }
        }
        ...
        function bc(b9) {
            var cc = {}, b8 = (b9 === "alt") ? "elapsed" : b9, cb = W(b8 + "Background");
            if (cb.src) {
                var ca = by();
                ca.id = d(bU, b9);
        ...
        function bq(b8) {
            ...
            var ca = by(), cd = b8 === "volume", cb = b8 + (b8 === "time" ? "Slider" : ""), cg = cb + "Cap", cc = cd ? "Top" : "Left", ci = cd ? "Bottom" : "Right", ce = Z(cg + cc, null, false, false, cd), cf = Z(cg + ci, null, false, false, cd), b9 = bA(b8, cd, cc, ci), cj = W(cg + cc), ch = W(cg + cc);
        ...
        function bA(cr, b9, cd, cp) {
            ...
            for (var ck = 0; ck < ci.length; ck++) {
                cl = (cr === "time" ? "Slider" : "");
                var cj = cr + cl + ci[ck], cc = Z(cj, null, !b9, (cr.indexOf("volume") === 0), b9), cf = Z(cj + "Cap" + cd, null, false, false, b9), cg = Z(cj + "Cap" + cp, null, false, false, b9), cb = W(cj + "Cap" + cd), b8 = W(cj + "Cap" + cp);
                if (cc) {
                    var ch = by();
                    ...
                    p(V(".jwrailgroup." + ci[ck]), {"min-width": (b9 ? "" : cb.width + b8.width)});
                    ch.capSize = b9 ? cb.height + b8.height : cb.width + b8.width;
                    p(V("." + cc.className), {
                        left: b9 ? "" : cb.width,
                        right: b9 ? "" : b8.width,
                        top: b9 ? cb.height : "",
            ...
            if (cn) {
                p(V("." + cn.className), {opacity: cr === "time" ? 0 : 1, "margin-top": b9 ? cn.skin.height / -2 : ""});
        ...
        function bM(b8) {
            ...
            var cb = aI[S].querySelector(".jwrail"), cc = v.bounds(cb), ca = b8.x / cc.width;
            if (ca > 100) {
                ca = 100
            }
        ...
        function at(b8) {
            var ca = aI.time.querySelector(".jwrail"), cb = v.bounds(ca), b9 = b8.x / cb.width;
            if (b9 > 100) {
                b9 = 100
            }
            if (!F()) {
        ...
        function bF(b8) {
            ...
            if (al()) {
                cb = aI[b9].vertical ? ((cd.bottom * 100 - b8.pageY) / (cd.height * 100)) : ((b8.pageX - (cd.left * 100)) / (cd.width * 100))
            } else {
                cb = aI[b9].vertical ? ((cd.bottom - b8.pageY) / cd.height) : ((b8.pageX - cd.left) / cd.width)
            }
            if (b8.type === "mouseup") {
                if (b9 === "time") {
                    bS.jwSeekDrag(false)
        ...
        var bv = (function () {
            ...
            return function (ca) {
                ...
                if (B) {
                    ...
                    if (cb && (cb !== b9)) {
                        b9 = cb;
                        p.style(bt.element(), {width: (cb.length > 32) ? 160 : ""})
                    }
                } else {
                    cb = v.timeFormat(ca);
                    if (!cc) {
                        p.style(bt.element(), {width: ""})
                    }
                }
                if (aH.innerHTML !== cb) {
                    aH.innerHTML = cb
        ...
        function L() {
            ...
            if (aI.timeSliderThumb) {
                p.style(aI.timeSliderThumb, {"margin-left": (W("timeSliderThumb").width / -2)})
            }
            var ca = "timeSliderCue", b8 = W(ca), b9 = {"z-index": 1};
            if (b8 && b8.src) {
                Z(ca);
        ...
        function aY(cc, cb) {
            if (/^[\d\.]+%?$/.test(cc.toString())) {
                var b9 = Z("timeSliderCue"), ca = aI.timeSliderRail, b8 = {position: cc, text: cb, element: b9};
                if (b9 && ca) {
                    ca.appendChild(b9);
        ...
        function aZ(ca, b8, cd, b9) {
            var cb = "volume" + (b8 ? "" : "H"), cc = b8 ? "vertical" : "horizontal";
            p(V(".jw" + cb + ".jw" + cc), {
                width: W(cb + "Rail", b8).width + (b8 ? 0 : (W(cb + "Cap" + cd).width + W(cb + "RailCap" + cd).width + W(cb + "RailCap" + b9).width + W(cb + "Cap" + b9).width)),
                height: b8 ? (W(cb + "Cap" + cd).height + W(cb + "Rail").height + W(cb + "RailCap" + cd).height + W(cb + "RailCap" + b9).height + W(cb + "Cap" + b9).height) : ""
            });
            ca.className += " jw" + cc
        }
        ...
        function a3() {
            ...
            bx(av, aQ.right);
            aV();
            p.style(aQ.right, {right: W("capRight").width})
        }
        ...
        bd.redraw = function (ca) {
            ...
            var ce = x && v.isMSIE();
            var b9 = bY.active;
            p.style(aI.fullscreen, {display: (a4 || b9 || bI || ce) ? "none" : ""});
            p.style(aI.volumeH, {display: a4 || aT ? "block" : "none"});
            var cd = Math.floor(a8.maxwidth);
            if (cd) {
                if (av.parentNode && v.isIE()) {
                    if (!a4 && av.parentNode.clientWidth > cd + (Math.floor(a8.margin) * 2)) {
                        p.style(av, {width: cd})
                    } else {
                        p.style(av, {width: ""})
                    }
            ...
            if (aO) {
                p.style(aO.element(), {display: !(a4 || aT) ? "block" : "none"})
            }
            p.style(aI.hd, {display: !a4 && !b9 && be() ? "" : "none"});
            p.style(aI.cc, {display: !a4 && b4() ? "" : "none"});
            aR();
            p.unblock(bU);
            if (bd.visible) {
                ...
                if (al()) {
                    b8 = {
                        left: Math.round(v.parseDimension(aQ.left.offsetWidth * 62) + cc.width),
                        right: Math.round(v.parseDimension(aQ.right.offsetWidth * 86) + cb.width)
                    }
                } else {
                    b8 = {
                        left: Math.round(v.parseDimension(aQ.left.offsetWidth) + cc.width),
                        right: Math.round(v.parseDimension(aQ.right.offsetWidth) + cb.width)
                    }
                }
        ...
        function aN(b8) {
            if (aI.timeSliderBuffer) {
                ...
                p.style(aI.timeSliderBuffer, {width: (b8 * 100).toFixed(1) + "%", opacity: b8 > 0 ? 1 : 0})
            }
        }
        ...
        function bR(cb, cf) {
            ...
            var b9 = aI[cb].vertical, ce = cb + (cb === "time" ? "Slider" : ""), cc = 100 * Math.min(Math.max(0, cf), 1) + "%", ca = aI[ce + "Progress"], b8 = aI[ce + "Thumb"], cd;
            if (ca) {
                cd = {};
                if (b9) {
                    cd.height = cc;
        ...
        function W(b9) {
            ...
            if (cb) {
                ...
                return {width: 0, height: 0, src: "", image: g, ready: false}
            }
        }
        ...
        bd.hide = function () {
            ...
            bd.visible = false;
            p.style(av, {opacity: 0});
            br();
            T = setTimeout(function () {
                p.style(av, {display: "none"})
            }, y)
        };
        aa()
    };
    (function () {
        ...
        p(D, {position: C, margin: "auto", opacity: 0, display: "none"});
        p(D + " span", {height: "100%"});
        v.dragStyle(D + " span", "none");
        p(D + " .jwgroup", {display: "inline"});
        p(D + " span, " + D + " .jwgroup button," + D + " .jwleft", {position: B, "float": "left"});
        p(D + " .jwright", {position: B, "float": "right"});
        p(D + " .jwcenter", {position: C});
        p(D + " button", {display: "inline-block", height: "100%", border: "none", cursor: "pointer"});
        p(D + " .jwcapRight," + D + " .jwtimeSliderCapRight," + D + " .jwvolumeCapRight", {right: 0, position: C});
        p(D + " .jwcapBottom", {bottom: 0, position: C});
        p(D + " .jwtime", {position: C, height: "100%", width: "100%", left: 0});
        p(D + " .jwthumb", {position: C, height: "100%", cursor: "pointer"});
        p(D + " .jwrail", {position: C, cursor: "pointer"});
        p(D + " .jwrailgroup", {position: C, width: "100%"});
        p(D + " .jwrailgroup span", {position: C});
        p(D + " .jwdivider+.jwdivider", {display: "none"});
        p(D + " .jwtext", {padding: "0 5px", "text-align": "center"});
        p(D + " .jwcast", {display: "none"});
        p(D + " .jwcast.jwcancast", {display: "block"});
        p(D + " .jwalt", {display: "none", overflow: "hidden"});
        p(D + " .jwalt", {position: C, left: 0, right: 0, "text-align": "left"}, true);
        p(D + " .jwoverlaytext", {padding: 3, "text-align": "center"});
        p(D + " .jwvertical *", {display: "block"});
        p(D + " .jwvertical .jwvolumeProgress", {height: "auto"}, true);
        p(D + " .jwprogressOverflow", {position: C, overflow: "hidden"});
        w(D, A);
        w(D + " button", A);
        w(D + " .jwtoggling", "none")
    })()
...
(function (d) {
    ...
    c.controller = function (m, j) {
        var s = false, o = -1, B = false, L, P = false, h, z = [], n = a.extend(this, new e.eventdispatcher(m.id, m.config.debug));
        ...
        function t(U) {
            if (!s) {
                ...
                n.sendEvent(d.events.JWPLAYER_PLAYLIST_LOADED, {playlist: d(m.id).getPlaylist()});
                n.sendEvent(d.events.JWPLAYER_PLAYLIST_ITEM, {index: m.item});
                N();
...
(function (b) {
    var c = b.html5, g = b.utils, h = b.events, i = h.state, e = g.css, f = g.isMobile(), a = ".jwdisplay", d = ".jwpreview";
    var j = {
        showicons: true,
        bufferrotation: 45,
        bufferinterval: 100,
    ...
    c.display = function (m, N) {
        var z = m.skin, X, aa, I, E, o, B, T, k = false, ab = {}, R = false, W = false, l, K, F, P, G, Y = g.extend({}, j, z.getComponentSettings("display"), N), O = new h.eventdispatcher(), p, V;
        g.extend(this, O);
        function U() {
        ...
        function Z(ad) {
            ...
            var ac = g.bounds(X.parentNode.querySelector(".jwcontrolbar")), ah = g.bounds(X), ag = {
                left: ac.left - 10 - ah.left,
                right: ac.left + 30 - ah.left,
                top: ah.bottom - 40,
                bottom: ah.bottom
            }, af = {left: ac.right - 30 - ah.left, right: ac.right + 10 - ah.left, top: ag.top, bottom: ag.bottom};
            if (f) {
                if (H(ag, ad.x, ad.y)) {
                } else {
                    if (H(af, ad.x, ad.y)) {
        ...
        function S() {
            var ac = {
                font: Y.fontweight + " " + Y.fontsize + "px/" + (parseInt(Y.fontsize, 10) + 3) + "px Arial, Helvetica, sans-serif",
                color: Y.fontcolor
            }, ad = {color: Y.overcolor};
        ...
        function u(ac, ad) {
            ...
            if (ac || ad) {
                F.setRotation(ac === "buffer" ? parseInt(Y.bufferrotation, 10) : 0, parseInt(Y.bufferinterval, 10));
                F.setIcon(ac);
                F.setText(ad)
            } else {
                F.hide()
        ...
        function w() {
            if (X.clientWidth * X.clientHeight > 0) {
                g.stretch(m.jwGetStretching(), aa, X.clientWidth, X.clientHeight, B, T)
            }
        }

        this.redraw = w;
        function L(ac, ad) {
            e(M(ac), {opacity: ad ? 1 : 0, visibility: ad ? "visible" : "hidden"})
        }
    ...
    e(a, {position: "absolute", width: "100%", height: "100%", overflow: "hidden"});
    e(a + " " + d, {
        position: "absolute",
        width: "100%",
        height: "100%",
...
(function (b) {
    ...
    d.displayicon = function (n, H, s, B) {
        var v = H.skin, w, I, O, z, u, m, C, A = {}, E, D = 0, x = -1, L = 0;
        ...
        function t() {
            ...
            if (!h.isMobile()) {
                ...
                f(".jw-tab-focus " + p() + ", #" + H.id + " .jwdisplay:hover " + p(), P)
            }
        }
        ...
        function M(R, P, T, Q) {
            ...
            if (S.src) {
                ...
                T.width = S.width;
                T["background-image"] = "url(" + S.src + ")";
                T["background-size"] = S.width + "px " + S.height + "px";
                T["float"] = "none";
                f.style(w, {display: "table"})
            } else {
                f.style(w, {display: "none"})
            }
            if (T) {
                f("#" + H.id + " .jwdisplay " + P, T)
            }
            if (Q) {
        ...
        function F(Q) {
            var R = v.getSkinElement("display", Q), P = v.getSkinElement("display", Q + "Over");
            if (R) {
        ...
        function l() {
            var P = u || (D === 0);
            f.style(m, {display: (m.innerHTML && P) ? "" : a});
            L = P ? 30 : 0;
            r()
        }
        ...
        function r() {
            ...
            var Q = [O.width + R, P + R, z.width + R].join(", ");
            var S = {"background-size": Q};
            if (w.parentNode) {
                S.left = (w.parentNode.clientWidth % 2 === 1) ? "0.5px" : ""
            }
            f.style(w, S)
        }
    ...
    f(c + " div", {"vertical-align": "middle"}, true);
    f(c + " .jwtext", {
        color: "#fff",
        padding: "0 1px",
        "max-width": "300px",
...
(function (c) {
    ...
    b.dock = function (t, E) {
        ...
        function s() {
            ...
            d(j(), {height: H.height, padding: o.margin});
            d(f, {height: H.height});
            d(j("div.button"), a.extend(n(H), {width: H.width, cursor: "pointer", border: "none"}));
            d(j("div.button:hover"), n(I));
            d(j("div.button:active"), n(J));
            d(j("div.button>div"), {opacity: o.iconalpha});
            d(j("div.button:hover>div"), {opacity: o.iconalphaover});
            d(j("div.button:active>div"), {opacity: o.iconalphaactive});
            d(j(".jwoverlay"), {top: o.margin + H.height});
            B("capLeft", A);
            B("capRight", A);
            B("divider")
        }
        ...
        function n(H) {
            ...
            return {background: "url(" + H.src + ") center", "background-size": H.width + "px " + H.height + "px"}
        }

        function B(J, I) {
            var H = u(J);
            d(j("." + J), a.extend(n(H), {width: H.width}));
            return D("div", J, I)
        }
        ...
        function u(H) {
            ...
            return I ? I : {width: 0, height: 0, src: ""}
        }
        ...
        function G(I) {
            ...
            M = h(q);
            if (C()) {
                d("#" + L.element().id, {left: J.left * 100 + 50 + J.width * 100 / 2})
            } else {
                d("#" + L.element().id, {left: J.left - M.left + J.width / 2})
            }
            H = h(L.element());
            if (M.left > H.left) {
        ...
        y.addButton = function (I, Q, M, J) {
            ...
            var K = D("div", "divider", A), L = D("div", "button", A), P = D("div", null, L);
            P.id = i + "_" + J;
            P.innerHTML = "&nbsp;";
            d("#" + P.id, {"background-image": I});
            if (typeof M === "string") {
                M = new Function(M)
            }
            if (!a.isMobile()) {
            ...
            l[J] = {element: L, label: Q, divider: K, icon: P};
            if (Q) {
        ...
        function k() {
            d(f + " .capLeft, " + f + " .capRight", {display: z ? "block" : "none"})
        }

        r()
    };
    d(e, {opacity: 0, display: "none"});
    d(e + " > *", {height: "100%", "float": "left"});
    d(e + " > .jwoverlay", {height: "auto", "float": "none", "z-index": 99});
    d(f + " div.button", {position: "relative"});
    d(f + " > *", {height: "100%", "float": "left"});
    d(f + " .divider", {display: "none"});
    d(f + " div.button ~ .divider", {display: "block"});
    d(f + " .capLeft, " + f + " .capRight", {display: "none"});
    d(f + " .capRight", {"float": "right"});
    d(f + " div.button > div", {
        left: 0,
        right: 0,
        top: 0,
...
(function (c) {
    ...
    a.instream = function (C, G, n, x) {
        ...
        }, h, t, I, j, k, K, l, p, o, i, F = -1, E = e.extend(this, new f.eventdispatcher());
        ...
        E.init = function () {
            ...
            if (x.checkBeforePlay() || I === 0) {
                ...
                if (C.jwGetState() === d.IDLE || G.getVideo().checkComplete()) {
                    j = d.IDLE
                } else {
                    j = d.PLAYING
                }
            ...
            e.css.style(i, {width: "100%", height: "100%"});
            i.appendChild(o.element());
            var P = {fullscreen: G.fullscreen};
        ...
        E.load = function (T, Q) {
            if (e.isAndroid(2.3)) {
                s({type: f.JWPLAYER_ERROR, message: "Error loading instream: Cannot play instream on Android 2.3"});
                return
            }
            D(f.JWPLAYER_PLAYLIST_ITEM, {index: y}, true);
            var S = i.parentNode;
        ...
        E.jwInstreamDestroy = function (P) {
            ...
            D(f.JWPLAYER_INSTREAM_DESTROYED, {reason: P ? "complete" : "destroyed"}, true);
            if (j === d.PLAYING) {
                t.play()
            }
        ...
        function A(P) {
            ...
            D(f.JWPLAYER_FULLSCREEN, {fullscreen: P.jwstate})
        }
...
(function (b) {
    var i = b.utils, e = b.html5, h = i.css, k = b.events.state, f = "free", c = "pro", d = "premium", j = "ads", l = "http://www.longtailvideo.com/jwpabout/?a=l&v=", g = ".jwlogo";
    ...
    a.defaults = {
        prefix: i.repo(),
        file: "images/ss_logo_35_35.png",
        linktarget: "_top",
        margin: 8,
        hide: false,
        position: "top-right"
    };
    h(g, {cursor: "pointer", position: "absolute"})
})(jwplayer);
(function (e) {
    ...
    d.menu = function (i, j, w, p) {
        ...
        function s() {
            ...
            if (z) {
                ...
                f(x + ":hover", b.extend(u(y), {color: n.overcolor}));
                f(x + ".active", b.extend(u(A), {color: n.activecolor}))
            }
            m.setContents(l)
        }
        ...
        function o(x) {
            ...
            return y ? y : {width: 0, height: 0, src: undefined}
        }
    ...
    f(c(g + " " + a), {cursor: "pointer", "white-space": "nowrap", position: "relative"})
})(jwplayer);
(function (c) {
    var b = c.html5, a = c.utils, d = c.events;
    b.model = function (h, e) {
        var n = this, j, p = a.getCookies(), f = {controlbar: {}, display: {}}, g = a.noop, l = {
            autostart: false,
            controls: true,
            fullscreen: false,
            height: 320,
        ...
        function o() {
            ...
            a.extend(n, {id: h.id, state: d.state.IDLE, duration: -1, position: 0, buffer: 0}, n.config);
            n.playlist = [];
            n.setItem(0)
        }
        ...
        n.setFullscreen = function (q) {
            ...
            if (q !== n.fullscreen) {
                n.fullscreen = q;
                n.sendEvent(d.JWPLAYER_FULLSCREEN, {fullscreen: q})
            }
        };
        n.setPlaylist = function (q) {
            n.playlist = c.playlist.filterPlaylist(q, n.androidhls);
            if (n.playlist.length === 0) {
                n.sendEvent(d.JWPLAYER_ERROR, {message: "Error loading playlist: No playable sources found"})
            } else {
                n.sendEvent(d.JWPLAYER_PLAYLIST_LOADED, {playlist: c(n.id).getPlaylist()});
                n.item = -1;
                n.setItem(0)
            }
        };
        n.setItem = function (q) {
            ...
            if (u || r !== n.item) {
                n.item = r;
                n.sendEvent(d.JWPLAYER_PLAYLIST_ITEM, {index: n.item});
                var s = n.playlist[r];
        ...
        n.setVolume = function (q) {
            ...
            i({type: d.JWPLAYER_MEDIA_VOLUME, volume: q});
            j.volume(q)
        };
        n.setMute = function (q) {
            ...
            a.saveCookie("mute", q);
            i({type: d.JWPLAYER_MEDIA_MUTE, mute: q});
            j.mute(q)
        };
...
(function (e) {
    ...
    h.overlay = function (z, B, x) {
        var C = this, p = z, u = B, D = x, v, G, A, n, o = l.extend({}, f, u.getComponentSettings("tooltip")), r = {};
        ...
        function w() {
            ...
            k.style(H[0], {left: r.left, right: r.right, top: r.top, bottom: r.bottom});
            G = E(g, v);
            k(s(g) + " *", {
                color: o.fontcolor,
            ...
            k.style(v, {padding: (r.top + 1) + "px " + r.right + "px " + (r.bottom + 1) + "px " + r.left + "px"});
            C.showing = false
        }
        ...
        function F(N, M) {
            ...
            var J = q("cap" + N + M, "jwborder jw" + N + (M ? M : "")), H = J[0], K = J[1], I = l.extend(t(K), {
        ...
        C.offsetX = function (I) {
            ...
            var H = v.clientWidth;
            if (H !== 0) {
                k.style(v, {"margin-left": Math.round(-H / 2) + I});
                k.style(n, {"margin-left": Math.round(-A.width / 2) - I})
            }
            return H
        };
        ...
        function y(H) {
            ...
            if (I) {
                ...
                return {width: 0, height: 0, src: "", image: undefined, ready: false}
            }
        }

        C.show = function () {
            C.showing = true;
            k.style(v, {opacity: 1, visibility: "visible"})
        };
        C.hide = function () {
            C.showing = false;
            k.style(v, {opacity: 0, visibility: "hidden"})
        };
        w()
    };
    k(b, {position: "absolute", visibility: "hidden", opacity: 0});
    k(b + " .jwcontents", {position: "relative", "z-index": 1});
    k(b + " .jwborder", {position: "absolute", "background-size": "100% 100%"}, true);
    k(b + " .jwback", {position: "absolute", "background-size": "100% 100%"});
...
(function (c) {
    ...
    b.player = function (f) {
        ...
        function d(r) {
            var s = {description: r.description, file: r.file, image: r.image, mediaid: r.mediaid, title: r.title};
...
(function (c) {
    ...
    f.playlistcomponent = function (E, P) {
        var I = E, x = I.skin, o = j.extend({}, d, I.skin.getComponentSettings("playlist"), P), J, y, m, q, w = -1, z, p, r = 76, s = {
        ...
        function C() {
            var T = 0, S = 0, Q = 0;
            j.clearCss(t());
            h(t(), {"background-color": o.backgroundcolor});
            h(t("jwlist"), {"background-image": s.background ? " url(" + s.background.src + ")" : ""});
            h(t("jwlist *"), {
                color: o.fontcolor,
                font: o.fontweight + " " + o.fontsize + "px Arial, Helvetica, sans-serif"
            });
            ...
            h(t("jwplaylistimg"), {height: Q, width: S, margin: T ? (T + "0 " + T + T) : "0 5px 0 0"});
            h(t("jwlist li"), {
            ...
            h(t("jwlist li.active .jwtitle"), {color: o.titleactivecolor});
            h(t("jwlist li.active .jwdescription"), {color: o.activecolor});
            var U = {overflow: "hidden"};
            if (o.overcolor !== "") {
                U.color = o.overcolor
            }
            if (s.itemOver) {
            ...
            if (!i) {
                ...
                h(t("jwlist li:hover .jwtitle"), {color: o.titleovercolor});
                h(t("jwlist li:hover .jwdescription"), {color: o.overcolor})
            }
            h(t("jwtextwrapper"), {height: r, position: "relative"});
            h(t("jwtitle"), {
                overflow: "hidden",
                display: "inline-block",
                height: v ? r : 20,
        ...
        function D(U) {
            ...
            if (X && !v) {
                h("#" + Y.id + " .jwplaylistimg", {"background-image": X});
                O(Y, V)
            }
    ...
    h(k, {position: "absolute", width: "100%", height: "100%"});
    j.dragStyle(k, "none");
    h(k + " .jwplaylistimg", {
        position: "relative",
        width: "100%",
    ...
    h(k + " .jwlistcontainer", {position: "absolute", overflow: "hidden", width: "100%", height: "100%"});
    h(k + " .jwlist li", {width: "100%"});
    h(k + " .jwtextwrapper", {overflow: "hidden"});
    h(k + " .jwplaylistdivider", {position: "absolute"});
    if (i) {
...
(function (i) {
    ...
    i.playlistslider = function (U, M, I, Y) {
        ...
        function H() {
            ...
            ai(o, ac, D, true);
            ai(l, ab, D);
            m(W(o), {top: y.height, bottom: ab.height});
            ai(u, F, ad);
            ai(h, w, ad, true);
            ai(t, P, ad);
            m(W(h), {top: F.height, bottom: P.height});
            J();
            if (Z) {
                if (!B) {
        ...
        function G(al) {
            ...
            return am ? am : {width: 0, height: 0, src: v}
        }
        ...
        function S(al) {
            ...
            if (al > 1) {
                ...
                ak = true;
                m(W(b), {height: Math.max(D.clientHeight * al, F.height + P.height)})
            }
            m(W(), {visibility: ak ? "visible" : j});
            if (Z) {
        ...
        var L = this.thumbPosition = function (al) {
            ...
            m(W(b), {top: T + (D.clientHeight - ad.clientHeight) * ah});
            if (Y) {
        ...
        function aa(al) {
            if (R || al.type === "click") {
                var aq = r.bounds(D), an = ad.clientHeight / 2, am = aq.height - an, ap = al.pageY - aq.top, ao = (ap - an) / (am - an);
                L(ao)
            }
        }
    ...
    m(c(a), {position: f, height: k, visibility: j, right: 0, top: 0, cursor: "pointer", "z-index": 1, overflow: j});
    m(c(a) + " *", {
        position: f,
        width: k,
        "background-position": "center",
...
(function (e) {
    var k = jwplayer.utils, i = k.css, a = "About JW Player ", l = "http://www.longtailvideo.com/jwpabout/?a=r&v=", j = document, h = ".jwclick", g = h + "_item", f = "100%", d = "5px 5px 7px rgba(0,0,0,.10), 0px 1px 0px rgba(255,255,255,.3) inset", b = "none", c = "#FFF";
    ...
    i(g, {padding: "8px 21px", "text-align": "left", cursor: "pointer"}, true);
    i(g + ":hover", {"background-color": "#595959", color: c}, true);
    i(g + " a", {"text-decoration": b, color: "#000"}, true);
    i(h + " hr", {width: f, padding: 0, margin: 0, border: "1px #e9e9e9 solid"}, true)
})(jwplayer.html5);
(function (d) {
    var b = d.html5, a = d.utils, c = d._, e = d.events;
    b.setup = function (k, v) {
        var x = k, h = v, q, p = new e.eventdispatcher(), l = false;
        var F = {method: g, depends: []}, j = {method: E, depends: [F]}, D = {method: o, depends: [F]}, B = {
            method: C,
            depends: [D, j]
        }, r = {method: w, depends: [B, D]}, A = {method: t, depends: [r]};
        var m = [F, j, D, B, r, A];
        this.start = function () {
            c.defer(u)
        };
        ...
        function n(G) {
            l = true;
            p.sendEvent(e.JWPLAYER_ERROR, {message: G});
            h.setupError(G)
        }
...
(function (b) {
    ...
    b.skinloader = function (e, j, g) {
        var h = {}, l = j, r = g, p = true, s = e, f = false, u = jwplayer.utils.isMobile() ? 1 : 1, t = 1;
        ...
        function v(D) {
            var C = k(D, "skin")[0], L = k(C, "component"), W = C.getAttribute("target"), G = parseFloat(C.getAttribute("pixelratio"));
            if (G > 0) {
                t = G
            }
            if (!a.versionCheck(W)) {
                ...
                if (R && R.childNodes.length > 0) {
                    ...
                    for (var A = 0; A < S.length; A++) {
                        ...
                        for (var z = 0; z < T.length; z++) {
                            var y = T[z];
                            F.elements.push({type: y.tagName});
        ...
        function n(C, B) {
            B = i(B);
            var A = new Image(), x = i(C.getAttribute("name")), z = C.getAttribute("src"), E;
            ...
            h[B].elements[x] = {height: 0, width: 0, src: "", ready: false, image: A};
            A.onload = function () {
                o(A, x, B)
            };
            A.onerror = function () {
    ...
    b.thumbs = function (g) {
        ...
        function f(v, A) {
            if (v && v !== k) {
                ...
                var x = {display: "block", margin: "0 auto", "background-position": "0 0", width: 0, height: 0};
...
(function (k) {
    ...
    l.view = function (aQ, E) {
        ...
        function aR() {
            ...
            bd = H && ac;
            if (E.aspectratio) {
                s.style(a4, {display: "inline-block"});
        ...
        function aT() {
            aF = true;
            U.sendEvent(c.JWPLAYER_VIEW_TAB_FOCUS, {hasFocus: false})
        }
        ...
        function I() {
            ...
            aF = false;
            if (bk) {
                U.sendEvent(c.JWPLAYER_VIEW_TAB_FOCUS, {hasFocus: true})
            }
            if (!a1.adMode()) {
                G();
                aB()
        ...
        function aP() {
            var bk = t(a4), bm = Math.round(bk.width), bl = Math.round(bk.height);
            if (!document.body.contains(a4)) {
                ...
                if (bm && bl) {
                    if (bm !== at || bl !== Y) {
                        ...
                        clearTimeout(a7);
                        a7 = setTimeout(al, 50);
                        U.sendEvent(c.JWPLAYER_RESIZE, {width: bm, height: bl})
                    }
                }
            }
            return bk
        ...
        this.setup = function (bn) {
            ...
            aQ.jwAddEventListener(c.JWPLAYER_CAST_SESSION, function (bo) {
                ...
                if (bo.active) {
                    s.style(aY.element(), {display: "none"});
                    U.forceControls(true);
                    be.setState("connecting").setName(bo.deviceName).show();
                    aQ.jwAddEventListener(c.JWPLAYER_PLAYER_STATE, be.statusDelegate);
                    aQ.jwAddEventListener(c.JWPLAYER_CAST_AD_CHANGED, bh)
                } else {
                    aQ.jwRemoveEventListener(c.JWPLAYER_PLAYER_STATE, be.statusDelegate);
                    aQ.jwRemoveEventListener(c.JWPLAYER_CAST_AD_CHANGED, bh);
                    be.hide();
                    if (a1.adMode()) {
                        aK()
                    }
                    s.style(aY.element(), {display: null});
                    P({newstate: aQ.jwGetState()});
                    aP()
                }
            });
            P({newstate: i.IDLE});
            ...
            aa(aE);
            aa(L);
            s("#" + a4.id + "." + e + " ." + b, {"margin-top": E.aspectratio, display: n});
            var bk = y.exists(E.aspectratio) ? parseFloat(E.aspectratio) : 100, bl = E.playlistsize;
            s("#" + a4.id + ".playlist-right ." + b, {"margin-bottom": -1 * bl * (bk / 100) + "px"});
            s("#" + a4.id + ".playlist-right ." + h, {width: bl + "px", right: 0, top: 0, height: "100%"});
            s("#" + a4.id + ".playlist-bottom ." + b, {"padding-bottom": bl + "px"});
            s("#" + a4.id + ".playlist-bottom ." + h, {width: "100%", height: bl + "px", bottom: 0});
            s("#" + a4.id + ".playlist-right ." + r, {right: bl + "px"});
            s("#" + a4.id + ".playlist-bottom ." + r, {bottom: bl + "px"});
            setTimeout(function () {
                S(E.width, E.height)
            }, 0)
        };
        ...
        function T() {
            var bk = E.height, bm = E.componentConfig("controlbar"), bl = E.componentConfig("display");
            ab(bk);
            ...
            if (aQ.edition && !w) {
                an = new l.rightclick(aQ, {abouttext: E.abouttext, aboutlink: E.aboutlink})
            } else {
                if (!w) {
        ...
        function S(bl, bs, bp) {
            ...
            if (L) {
                L.offset(a1 && L.position().indexOf("bottom") >= 0 ? a1.height() + a1.margin() : 0);
                setTimeout(function () {
                    if (aE) {
        ...
        function W() {
            if (bd) {
                var bk = document.fullscreenElement || document.webkitCurrentFullScreenElement || document.mozFullScreenElement || document.msFullscreenElement;
        ...
        function aI(bl, bk) {
            ...
            if (bk) {
                ...
                s.style(document.body, {"overflow-y": m});
                aB()
            } else {
                s.style(document.body, {"overflow-y": ""})
            }
            bb(a1);
            bb(af);
            bb(aE);
        ...
        function ad(bk) {
            ...
            if (bi()) {
                ...
                s.style(av, {visibility: "visible", opacity: 1});
                if (a1) {
                    a1.show();
        ...
        this.setControls = function (bl) {
            ...
            U.sendEvent(c.JWPLAYER_CONTROLS, {controls: bk})
        };
        ...
        this.getSafeRegion = function (bl) {
            var bk = {x: 0, y: 0, width: 0, height: 0};
            bl = bl || !y.exists(bl);
            a1.showTemp();
            aE.showTemp();
            var bs = t(a8), bn = bs.top, bq = aD ? t(document.getElementById(aQ.id + "_instream_controlbar")) : t(a1.element()), bm = aD ? false : (aE.numButtons() > 0), br = (L.position().indexOf("top") === 0), bp, bo = t(L.element());
            if (bm && E.controls) {
                bp = t(aE.element());
    ...
    s("." + z, {overflow: m, visibility: m, opacity: 0});
    s("." + z + " video", {
    ...
    s("." + h, {position: j, height: o, width: o, display: a});
    s("." + A, {position: j, top: 0, left: 0, bottom: 0, right: 0, display: "none"});
    s("." + b, {display: "none"});
    s("." + q + "." + e, {height: "auto"});
    s(d, {
        width: o,
    ...
    s(d + ".jw-user-inactive", {cursor: "none", "-webkit-cursor-visibility": "auto-hide"});
    s(d + " ." + r, {left: 0, right: 0, top: 0, bottom: 0}, true);
    s(d + " ." + h, {display: a}, true);
    s("." + q + " .jwuniform", {"background-size": "contain" + u});
    s("." + q + " .jwfill", {"background-size": "cover" + u, "background-position": "center"});
    s("." + q + " .jwexactfit", {"background-size": o + " " + o + u})
})(window);