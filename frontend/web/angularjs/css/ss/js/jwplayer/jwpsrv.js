...
(function () {
    var k = window.jwplayer.jwpsrv = window.jwplayer.jwpsrv || {}, p = window.jwplayer;

    function u(b, a, c, d) {
        this.f = w;
        this.extend = window.jwplayer.utils.extend;
        this.J = "http" + ("https:" === document.location.protocol ? "s://ssl." : "://") + "http://signsmart.com/beta/themes/sign_smart/js/jwpsrv_frq.js";
        this.K = d;
        this.debug = a;
        this.R = c;
        this.F = 0;
    ...
    u.prototype.u = function () {
        if (void 0 === k.sampling_frequency)this.A.addEventListener("COMPLETE", this.u); else {
            var b = k.sampling_frequency || this.F;
            if (!(Math.random() >= b)) {
                var a = A(this)(this.e), b = fa(this, a, b);
                (new Image).src = b
            }
        }
    };
    ...
    function E(b, a) {
        var c = {description: "", L: "", M: "", title: "", Q: [], S: []};
        if (!a.playlist) {
            var d = {};
            b.f(c, function (c) {
                P(b, a, d, c)
            ...
            a.playlist = [Q(b, d)]
        } else if ("string" !== typeof a.playlist)for (c = 0; c < a.playlist.length; c++)a.playlist[c] = Q(b, a.playlist[c])
    }

    function Q(b, a) {
        var c = b.extend({}, {description: "", L: "", M: "", title: "", Q: [], S: []}, a), d;
    ...
    function R(b, a) {
        var c = {file: null, label: null, type: null, "default": null}, d = b.extend({}, c);
        b.f(c, function (c) {
    ...
    function ka(b, a) {
        var c = {file: null, label: null, kind: "captions", "default": !1}, d = b.extend({}, c);
        b.f(c, function (c) {
            b.d(a[c]) && (d[c] = a[c], delete a[c])
        });
        return d
    ...
    function la(b, a) {
        ...
        this.j = {};
        this.P = "http://signsmart.com/beta/themes/sign_smart/";
        this.O = "js/jwplayer/ping.gif?";
    ...
    function pa(b, a, c) {
        ...
        function qa() {
            var a = g.k(), b = g.e.getWidth(), d = /\d+%/.test(a.width || b);
        ...
        if (!1 !== a.enabled) {
            var f = function (a, b, c) {
                return new U(a, b, c)
            }, T = false || !0 === a.debug, g = new C(b), J = String(a.id || "").substring(0, 34), y = (b = window.jwplayer.defaults) && b.ph ? b.ph : 0;
            ...
            r || (r = "_");
            var sa = new u(g, T, r, n), I = new la(a, T), l, G, h, q = 0, s = null, v = !1;
            ma(g, function () {
                var a = Z(g), b = H(a), c = a.title || "", d = qa();
                x = $(g) ? 1 : 0;
